 ...
 */
@injectable()
export class WebviewExtensionConnector {
    ...
    protected _webviewViewConnection?: WebviewViewConnector;

    protected get webviewViewConnection(): WebviewViewConnector {
     ...
     */
    listen(_context: BIGWebviewProviderContext, webviewViewConnection: WebviewViewConnector, options?: { forwardCache: boolean }): void {
 ...
 */
@injectable()
export class WebviewViewConnector implements vscode.Disposable {
    @inject(TYPES.GLSPVSCodeConnector)
    protected readonly connector: BIGGLSPVSCodeConnector;
    ...
    protected onWebviewReadyEmitter = new vscode.EventEmitter<void>();
    readonly onWebviewReady = this.onWebviewReadyEmitter.event;
    ...
    listen(context: BIGWebviewProviderContext): void {
        ...
        this.disposables.push(
            ...
            this.messenger.onNotification(WebviewReadyNotification, () => this.onWebviewReadyEmitter.fire(), {
                sender: this.messageParticipant
            })
        );
