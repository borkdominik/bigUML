...
import { ElementWithSizeAndPosition, Relation, isElementWithSizeAndPosition, isRelation } from '../../../language-server/generated/ast.js';
...
export abstract class AbstractDeleteOperationHandler extends OperationHandler {
    ...
    protected collectAdditionalRemovesForNode(nodeId: string): {
