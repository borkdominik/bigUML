...
import { GModelElement, GModelElementConstructor, JsonOpenerOptions, NavigationTargetProvider } from '@eclipse-glsp/server';
import { injectable } from 'inversify';
import { BaseDiagramModelState } from '../model/base-diagram-model-state.js';

@injectable()
export abstract class AbstractNodeDocumentationNavigationTargetProvider<NodeT extends GModelElement, StateT extends BaseDiagramModelState>
