        ...
        return [
            SetPropertyPaletteAction.create(
                PropertyPalette.builder()
                    ...
                    .bool(semanticElement.__id, 'isException', !!semanticElement.isException, 'isException')
                    .bool(semanticElement.__id, 'isStream', !!semanticElement.isStream, 'isStream')
                    ...
                    .choice(semanticElement.__id, 'effect', PropertyPalette.DEFAULT_EFFECT_CHOICES, semanticElement.effect, 'Effect Type')
                    .choice(
                        semanticElement.__id,
                        'visibility',
