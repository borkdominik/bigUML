...
import { type TypescriptCodeGenerationOptions } from '../types/config.js';

interface TypescriptCodeGenerationConfigProps {
    options: TypescriptCodeGenerationOptions;
    setOptions: (value: React.SetStateAction<TypescriptCodeGenerationOptions>) => void;
    setIsGenerationDisabled: (value: React.SetStateAction<boolean>) => void;
}

export function TypescriptCodeGenerationConfig({
    options,
    setOptions,
    setIsGenerationDisabled
}: TypescriptCodeGenerationConfigProps): ReactElement {
