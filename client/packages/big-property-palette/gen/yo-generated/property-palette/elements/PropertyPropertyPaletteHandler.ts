...
import { Property } from '@borkdominik-biguml/model-server/grammar';
      ...
      SetPropertyPaletteAction.create(
        PropertyPalette.builder()
          ...
          .bool(
            semanticElement.__id,
            'isStatic',
            !!semanticElement.isStatic,
            'isStatic',
          )
          .bool(
            semanticElement.__id,
            'isDerivedUnion',
            !!semanticElement.isDerivedUnion,
            'isDerivedUnion',
          )
          .bool(
            semanticElement.__id,
            'isReadOnly',
            !!semanticElement.isReadOnly,
            'isReadOnly',
          )
          .bool(
            semanticElement.__id,
