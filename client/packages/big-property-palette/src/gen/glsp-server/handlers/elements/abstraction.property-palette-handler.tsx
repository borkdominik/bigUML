...
import { type Abstraction } from '@borkdominik-biguml/uml-model-server/grammar';
import {
...
export namespace AbstractionPropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<Abstraction>): SetPropertyPaletteAction[] {
        return [
