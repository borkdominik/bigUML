...
export namespace AcceptEventActionPropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<AcceptEventAction>): SetPropertyPaletteAction[] {
        return [
