...
export namespace ActivityFinalNodePropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<ActivityFinalNode>): SetPropertyPaletteAction[] {
        return [
