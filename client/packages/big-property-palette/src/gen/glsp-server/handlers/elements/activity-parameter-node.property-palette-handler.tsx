...
export namespace ActivityParameterNodePropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<ActivityParameterNode>): SetPropertyPaletteAction[] {
        return [
