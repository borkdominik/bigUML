...
export namespace ActivityPartitionPropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<ActivityPartition>): SetPropertyPaletteAction[] {
        return [
            SetPropertyPaletteAction.create(
                ...
                >
                    ...
                    <ReferenceProperty
                        ...
                        label='Subpartitions'
                        references={(context.semanticElement.subpartitions ?? [])
