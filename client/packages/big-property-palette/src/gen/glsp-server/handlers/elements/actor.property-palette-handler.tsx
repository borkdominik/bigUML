...
export namespace ActorPropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<Actor>): SetPropertyPaletteAction[] {
        return [
