...
import { type Aggregation } from '@borkdominik-biguml/uml-model-server/grammar';
import {
    ChoiceProperty,
    PropertyPalette,
...
export namespace AggregationPropertyPaletteHandler {
    export function getPropertyPalette(semanticElement: Aggregation): SetPropertyPaletteAction[] {
        return [
