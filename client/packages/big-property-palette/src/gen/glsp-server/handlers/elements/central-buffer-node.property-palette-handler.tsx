...
export namespace CentralBufferNodePropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<CentralBufferNode>): SetPropertyPaletteAction[] {
        return [
