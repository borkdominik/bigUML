...
export namespace ChoicePropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<Choice>): SetPropertyPaletteAction[] {
        return [
