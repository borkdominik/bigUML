...
import { type CommunicationPath } from '@borkdominik-biguml/uml-model-server/grammar';
import {
...
export namespace CommunicationPathPropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<CommunicationPath>): SetPropertyPaletteAction[] {
        return [
