...
export namespace DecisionNodePropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<DecisionNode>): SetPropertyPaletteAction[] {
        return [
