...
export namespace DeepHistoryPropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<DeepHistory>): SetPropertyPaletteAction[] {
        return [
