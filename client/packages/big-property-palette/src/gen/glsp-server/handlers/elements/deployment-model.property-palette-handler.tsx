...
export namespace DeploymentModelPropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<DeploymentModel>): SetPropertyPaletteAction[] {
        return [
