...
export namespace DeploymentPackagePropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<DeploymentPackage>): SetPropertyPaletteAction[] {
        return [
