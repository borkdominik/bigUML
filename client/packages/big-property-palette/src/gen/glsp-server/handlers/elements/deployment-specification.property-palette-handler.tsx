...
export namespace DeploymentSpecificationPropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<DeploymentSpecification>): SetPropertyPaletteAction[] {
        return [
