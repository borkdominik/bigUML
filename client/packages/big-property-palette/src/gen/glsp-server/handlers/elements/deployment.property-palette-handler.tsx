...
import { type Deployment } from '@borkdominik-biguml/uml-model-server/grammar';
import {
...
export namespace DeploymentPropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<Deployment>): SetPropertyPaletteAction[] {
        return [
