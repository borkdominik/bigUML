...
export namespace EntryPointPropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<EntryPoint>): SetPropertyPaletteAction[] {
        return [
