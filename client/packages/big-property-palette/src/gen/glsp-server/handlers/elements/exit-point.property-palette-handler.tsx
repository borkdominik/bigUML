...
export namespace ExitPointPropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<ExitPoint>): SetPropertyPaletteAction[] {
        return [
