...
export namespace ExtendPropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<Extend>): SetPropertyPaletteAction[] {
        return [
