...
export namespace FinalStatePropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<FinalState>): SetPropertyPaletteAction[] {
        return [
