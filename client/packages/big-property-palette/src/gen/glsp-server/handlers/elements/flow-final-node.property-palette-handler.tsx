...
export namespace FlowFinalNodePropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<FlowFinalNode>): SetPropertyPaletteAction[] {
        return [
