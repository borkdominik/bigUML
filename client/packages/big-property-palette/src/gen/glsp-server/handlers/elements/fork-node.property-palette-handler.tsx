...
export namespace ForkNodePropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<ForkNode>): SetPropertyPaletteAction[] {
        return [
