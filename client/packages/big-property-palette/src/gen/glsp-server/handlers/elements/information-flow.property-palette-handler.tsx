...
export namespace InformationFlowPropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<InformationFlow>): SetPropertyPaletteAction[] {
        return [
