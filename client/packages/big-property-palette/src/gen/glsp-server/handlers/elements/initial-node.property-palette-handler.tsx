...
export namespace InitialNodePropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<InitialNode>): SetPropertyPaletteAction[] {
        return [
