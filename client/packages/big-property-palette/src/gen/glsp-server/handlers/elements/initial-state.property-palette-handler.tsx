...
export namespace InitialStatePropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<InitialState>): SetPropertyPaletteAction[] {
        return [
