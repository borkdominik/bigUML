...
export namespace InputPinPropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<InputPin>): SetPropertyPaletteAction[] {
        return [
