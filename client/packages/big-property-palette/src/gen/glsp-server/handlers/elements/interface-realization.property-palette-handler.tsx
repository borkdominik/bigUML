...
import { type InterfaceRealization } from '@borkdominik-biguml/uml-model-server/grammar';
import {
...
export namespace InterfaceRealizationPropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<InterfaceRealization>): SetPropertyPaletteAction[] {
        return [
