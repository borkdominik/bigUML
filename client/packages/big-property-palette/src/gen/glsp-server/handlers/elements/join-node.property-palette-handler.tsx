...
export namespace JoinNodePropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<JoinNode>): SetPropertyPaletteAction[] {
        return [
