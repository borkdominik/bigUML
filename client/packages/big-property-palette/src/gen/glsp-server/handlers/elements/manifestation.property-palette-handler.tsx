...
import { type Manifestation } from '@borkdominik-biguml/uml-model-server/grammar';
import {
...
export namespace ManifestationPropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<Manifestation>): SetPropertyPaletteAction[] {
        return [
