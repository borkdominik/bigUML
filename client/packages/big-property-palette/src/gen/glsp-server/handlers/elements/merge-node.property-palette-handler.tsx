...
export namespace MergeNodePropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<MergeNode>): SetPropertyPaletteAction[] {
        return [
