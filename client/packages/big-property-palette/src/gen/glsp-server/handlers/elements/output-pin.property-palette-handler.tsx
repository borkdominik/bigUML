...
export namespace OutputPinPropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<OutputPin>): SetPropertyPaletteAction[] {
        return [
