...
export namespace SendSignalActionPropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<SendSignalAction>): SetPropertyPaletteAction[] {
        return [
