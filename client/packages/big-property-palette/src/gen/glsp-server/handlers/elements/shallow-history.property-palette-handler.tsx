...
export namespace ShallowHistoryPropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<ShallowHistory>): SetPropertyPaletteAction[] {
        return [
