...
export namespace StateMachinePropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<StateMachine>): SetPropertyPaletteAction[] {
        return [
