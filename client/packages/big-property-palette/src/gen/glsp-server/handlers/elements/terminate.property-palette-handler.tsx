...
export namespace TerminatePropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<Terminate>): SetPropertyPaletteAction[] {
        return [
