...
import { type Usage } from '@borkdominik-biguml/uml-model-server/grammar';
import {
...
export namespace UsagePropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<Usage>): SetPropertyPaletteAction[] {
        return [
