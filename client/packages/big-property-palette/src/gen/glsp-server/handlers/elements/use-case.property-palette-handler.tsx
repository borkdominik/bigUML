...
export namespace UseCasePropertyPaletteHandler {
    export function getPropertyPalette(context: GetPropertyPaletteHandlerContext<UseCase>): SetPropertyPaletteAction[] {
        return [
