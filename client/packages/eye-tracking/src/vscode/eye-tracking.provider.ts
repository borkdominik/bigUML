...
export class EyeTrackingProvider extends BIGReactWebview {
    ...
    protected readonly actionCache = this.actionListener.createCache([EyeTrackingActionResponse.KIND]);
    ...
    protected override handleConnection(): void {
        ...
        this.toDispose.push(
            ...
            this.connectionManager.onNoActiveClient(() => {
                ...
                this.webviewConnector.dispatch(EyeTrackingActionResponse.create());
            }),
    ...
    protected requestCount(): void {
        this.actionDispatcher.dispatch(
            RequestEyeTrackingAction.create({
                increase: 0
            })
        );
    }
