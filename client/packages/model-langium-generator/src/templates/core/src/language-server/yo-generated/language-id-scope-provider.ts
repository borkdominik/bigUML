...
import { PackageAstNodeDescription, PackageExternalAstNodeDescription } from './<%= language-id %>-scope.js';
...
export class PackageScopeProvider extends DefaultScopeProvider {
   constructor(protected services: <%= LanguageName %>Services, protected packageManager = services.shared.workspace.PackageManager) {
      super(services);
   }
...
export class <%= LanguageName %>ScopeProvider extends PackageScopeProvider {}