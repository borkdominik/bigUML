...
export class PackageScopeProvider extends DefaultScopeProvider {
   constructor(protected services: UmlDiagramServices, protected packageManager = services.shared.workspace.PackageManager) {
      super(services);
   }
...
export class UmlDiagramScopeProvider extends PackageScopeProvider {}