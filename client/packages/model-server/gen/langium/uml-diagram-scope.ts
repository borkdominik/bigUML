 ...
 */
export class UmlDiagramScopeComputation extends DefaultScopeComputation {
    declare nameProvider: QualifiedNameProvider;
    protected packageManager: UmlDiagramPackageManager;

    constructor(services: UmlDiagramServices) {
        super(services);
