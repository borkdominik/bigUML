import { AstNode, AstNodeLocator, GenericAstNode, LangiumDocuments, Mutable, NameProvider, Reference, isAstNode, streamAst } from 'langium';
...
export function rebuildLangiumReferences(
    ...
    function reviveReference(container: AstNode, property: string, root: AstNode, reference: IntermediateReference): Reference | undefined {
