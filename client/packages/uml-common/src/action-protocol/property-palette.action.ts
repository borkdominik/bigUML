...
import { ElementProperties } from './property-palette.model';
...
export interface RefreshPropertyPaletteAction extends Action {
    kind: typeof RefreshPropertyPaletteAction.KIND;
    elementId?: string;
}

export namespace RefreshPropertyPaletteAction {
    export const KIND = 'refreshPropertyPalette';

    export function is(object: any): object is RefreshPropertyPaletteAction {
        return Action.hasKind(object, KIND);
    }

    export function create(options?: { elementId?: string }): RefreshPropertyPaletteAction {
        return {
            kind: KIND,
            ...options
        };
