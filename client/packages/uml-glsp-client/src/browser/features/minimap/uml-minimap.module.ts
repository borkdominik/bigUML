 ...
 *********************************************************************************/
import { RequestMinimapExportSvgAction } from '@borkdominik-biguml/big-minimap';
import { TYPES, configureActionHandler, configureCommand } from '@eclipse-glsp/client';
import { ContainerModule } from 'inversify';
import { MinimapExportSvgCommand, MinimapExportSvgPostprocessor, MinimapGLSPSvgExporter, MinimapHandler } from './minimap.handler.js';
