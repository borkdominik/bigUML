...
export function registerDeploymentSpecificationElement(
    context: { bind: interfaces.Bind; isBound: interfaces.IsBound },
    representation: UMLDiagramType
): void {
    configureModelElement(context, QualifiedUtil.typeId(representation, 'DeploymentSpecification'), NamedElement, NamedElementView);
}
