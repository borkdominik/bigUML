...
export function registerInstanceSpecificationElement(
    context: { bind: interfaces.Bind; isBound: interfaces.IsBound },
    representation: UMLDiagramType
): void {
    configureModelElement(context, QualifiedUtil.typeId(representation, 'InstanceSpecification'), NamedElement, NamedElementView);
}
