...
export function registerExecutionEnvironmentElement(
    context: { bind: interfaces.Bind; isBound: interfaces.IsBound },
    representation: UMLDiagramType
): void {
    configureModelElement(context, QualifiedUtil.typeId(representation, 'ExecutionEnvironment'), NamedElement, NamedElementView);
}
