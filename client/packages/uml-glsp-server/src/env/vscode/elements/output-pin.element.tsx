...
export interface GOutputPinNodeElementProps extends BaseElementProps {
    node: OutputPin;
}

export function GOutputPinNodeElement(props: GOutputPinNodeElementProps): GModelElement {
    return (
        <GNodeElement
            id={props.node.__id}
            type={props.type}
...
export function createOutputPinElement(ctx: ElementContext<OutputPin>): GModelElement {
    ...
    return <GOutputPinNodeElement node={ctx.node} position={position} size={size} type={ctx.elementType} />;
}
