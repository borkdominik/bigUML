...
export interface DiagramSourceModel {
    text: string;
}
 ...
 */
@injectable()
export class DiagramModelState extends DefaultModelState implements JsonModelState<DiagramSourceModel> {
    @inject(DiagramModelIndex)
    declare index: DiagramModelIndex;
    ...
    get sourceModel(): DiagramSourceModel {
        return {
