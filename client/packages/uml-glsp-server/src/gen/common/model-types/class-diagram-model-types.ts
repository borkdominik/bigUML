...
import {
  representationTemplateTypeId,
  representationTypeId,
} from '../../../env/common/model/model-type-utils.js';
import { AstTypeUtils } from '../../../env/common/model/model-type-utils.js';

export namespace ClassDiagramNodeTypes {
  export const ENUMERATION = representationTypeId(
    'Class',
    DefaultTypes.NODE,
    'Enumeration',
  );
  export const ENUMERATION_LITERAL = representationTypeId(
    'Class',
    DefaultTypes.NODE,
    'EnumerationLiteral',
  );
  export const CLASS = representationTypeId(
    'Class',
    DefaultTypes.NODE,
    'Class',
  );
  export const ABSTRACT_CLASS = representationTypeId(
    'Class',
    DefaultTypes.NODE,
    'AbstractClass',
  );
  export const INTERFACE = representationTypeId(
    'Class',
    DefaultTypes.NODE,
    'Interface',
  );
  export const PACKAGE = representationTypeId(
    'Class',
    DefaultTypes.NODE,
    'Package',
  );
  export const PROPERTY = representationTypeId(
    'Class',
    DefaultTypes.NODE,
    'Property',
  );
  export const OPERATION = representationTypeId(
    'Class',
    DefaultTypes.NODE,
    'Operation',
  );
  export const PARAMETER = representationTypeId(
    'Class',
    DefaultTypes.NODE,
    'Parameter',
  );
  export const DATA_TYPE = representationTypeId(
    'Class',
    DefaultTypes.NODE,
    'DataType',
  );
  export const PRIMITIVE_TYPE = representationTypeId(
    'Class',
    DefaultTypes.NODE,
    'PrimitiveType',
  );
  export const INSTANCE_SPECIFICATION = representationTypeId(
    'Class',
    DefaultTypes.NODE,
    'InstanceSpecification',
  );
  export const SLOT = representationTypeId('Class', DefaultTypes.NODE, 'Slot');
  export const LITERAL_SPECIFICATION = representationTypeId(
    'Class',
    DefaultTypes.NODE,
...
export namespace ClassDiagramEdgeTypes {
  export const ABSTRACTION = representationTypeId(
    'Class',
    DefaultTypes.EDGE,
    'Abstraction',
  );
  export const DEPENDENCY = representationTypeId(
    'Class',
    DefaultTypes.EDGE,
    'Dependency',
  );
  export const ASSOCIATION = representationTypeId(
    'Class',
    DefaultTypes.EDGE,
    'Association',
  );
  export const AGGREGATION = representationTemplateTypeId(
    'Class',
    DefaultTypes.EDGE,
    'aggregation',
    'Association',
  );
  export const COMPOSITION = representationTemplateTypeId(
    'Class',
    DefaultTypes.EDGE,
    'composition',
    'Association',
  );
  export const INTERFACE_REALIZATION = representationTypeId(
    'Class',
    DefaultTypes.EDGE,
    'InterfaceRealization',
  );
  export const GENERALIZATION = representationTypeId(
    'Class',
    DefaultTypes.EDGE,
    'Generalization',
  );
  export const PACKAGE_IMPORT = representationTypeId(
    'Class',
    DefaultTypes.EDGE,
    'PackageImport',
  );
  export const PACKAGE_MERGE = representationTypeId(
    'Class',
    DefaultTypes.EDGE,
    'PackageMerge',
  );
  export const REALIZATION = representationTypeId(
    'Class',
    DefaultTypes.EDGE,
    'Realization',
  );
  export const SUBSTITUTION = representationTypeId(
    'Class',
    DefaultTypes.EDGE,
    'Substitution',
  );
  export const USAGE = representationTypeId(
    'Class',
    DefaultTypes.EDGE,
    'Usage',
  );
...
export namespace ClassDiagramModelTypes {
  ...
  export const LITERAL_SPECIFICATION =
  ...
  export const INTERFACE_REALIZATION =
