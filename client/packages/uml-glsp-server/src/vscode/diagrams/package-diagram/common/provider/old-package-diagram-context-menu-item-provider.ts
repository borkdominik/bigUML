...
@injectable()
export class PackageDiagramContextMenuItemProvider extends ContextMenuItemProvider {
    @inject(PackageDiagramModelState)
    protected modelState: PackageDiagramModelState;

    getItems(selectedElementIds: string[], position: Point, _args?: Args): MenuItem[] {
