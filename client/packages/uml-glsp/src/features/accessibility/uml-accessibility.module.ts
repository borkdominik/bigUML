...
import { SetAccessibleKeyShortcutAction } from '@eclipse-glsp/client/lib/features/accessibility/key-shortcut/accessible-key-shortcut';
import {
    Action,
    bindAsService,
    FeatureModule,
...
import {
    ...
    ResizeType
} from '@eclipse-glsp/client/lib/features/accessibility/resize-key-tool/resize-key-handler';
import { ShowToastMessageAction } from '@eclipse-glsp/client/lib/features/accessibility/toast/toast-handler';
...
import { EdgeAutocompletePalette } from '@eclipse-glsp/client/lib/features/accessibility/edge-autocomplete/edge-autocomplete-palette';
import { EdgeAutocompletePaletteTool } from '@eclipse-glsp/client/lib/features/accessibility/edge-autocomplete/edge-autocomplete-tool';
import {
    EnableKeyboardGridAction,
    KeyboardGridCellSelectedAction
} from '@eclipse-glsp/client/lib/features/accessibility/keyboard-grid/action';
import { KeyboardGrid } from '@eclipse-glsp/client/lib/features/accessibility/keyboard-grid/keyboard-grid';
import { GridSearchPalette } from '@eclipse-glsp/client/lib/features/accessibility/keyboard-grid/keyboard-grid-search-palette';
import { KeyboardNodeGrid } from '@eclipse-glsp/client/lib/features/accessibility/keyboard-grid/keyboard-node-grid';
import { SetKeyboardPointerRenderPositionAction } from '@eclipse-glsp/client/lib/features/accessibility/keyboard-pointer/actions';
import { KeyboardPointer } from '@eclipse-glsp/client/lib/features/accessibility/keyboard-pointer/keyboard-pointer';
...
import { ElementNavigator } from '@eclipse-glsp/client/lib/features/accessibility/element-navigation/element-navigator';
import { LocalElementNavigator } from '@eclipse-glsp/client/lib/features/accessibility/element-navigation/local-element-navigator';
import { PositionNavigator } from '@eclipse-glsp/client/lib/features/accessibility/element-navigation/position-navigator';
import { RepositionAction } from '@eclipse-glsp/client/lib/features/viewport/reposition';
