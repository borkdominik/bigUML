...
import { VerticalShiftNode } from './model';
...
@injectable()
export class VerticalShiftView extends RectangularNodeView {
    override render(node: VerticalShiftNode, context: RenderingContext): VNode {
        const graph = (
            <g>
                <defs>
                    <marker
...
@injectable()
export class HorizontalShiftView extends RectangularNodeView {
    override render(node: VerticalShiftNode, context: RenderingContext): VNode {
        const graph = (
