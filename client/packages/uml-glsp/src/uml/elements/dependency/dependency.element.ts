...
export class DependencyEdge extends LibavoidEdge {
    override routeType = RouteType.PolyLine;
}

export function registerDependencyElement(
    context: { bind: interfaces.Bind; isBound: interfaces.IsBound },
    representation: UmlDiagramType
): void {
    configureModelElement(
        context,
        QualifiedUtil.representationTypeId(representation, DefaultTypes.EDGE, 'Dependency'),
        DependencyEdge,
        GEdgeView,
        { disable: [editFeature] }
    );
