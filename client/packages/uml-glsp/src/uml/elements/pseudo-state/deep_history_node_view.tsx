    ...
    override render(node: CircularNode, context: RenderingContext): VNode {
        ...
        const deepHistoryNode: any = (
            <g>
                ...
                <line x1={-radius/4} y1={-radius/4} x2={radius/4} y2={radius/4} transform={`translate(${radius} ${radius / 2})`} fill="none" stroke="#ffffff" stroke-width="0.125em"/>
                <line x1={-radius/4} y1={radius/4} x2={radius/4} y2={-radius/4} transform={`translate(${radius} ${radius / 2})`} fill="none" stroke="#ffffff" stroke-width="0.125em"/>
                <line x1={-radius/4} y1="0" x2={radius/4} y2="0" transform={`translate(${radius} ${radius / 2})`} fill="none" stroke="#ffffff" stroke-width="0.125em"/>
                <line x1="0" y1={-radius/4} x2="0" y2={radius/4} transform={`translate(${radius} ${radius / 2})`} fill="none" stroke="#ffffff" stroke-width="0.125em"/>
