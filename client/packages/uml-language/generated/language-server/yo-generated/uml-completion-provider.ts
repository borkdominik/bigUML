...
import { isExternalDescriptionForLocalPackage } from './uml-scope.js';
 ...
 */
export class UmlCompletionProvider extends DefaultCompletionProvider {
   protected packageId?: string;

   constructor(services: UmlServices, protected packageManager = services.shared.workspace.PackageManager) {
      super(services);
   }
