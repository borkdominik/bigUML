...
import { type Definition, getReturnTypeFromDefinitions, type LangiumGrammar } from '../builder/grammar-transformer.js';
...
export function renderDiagramSerializer(rules: LangiumGrammar, languageId: string, languageName: string, generatorConfig: any): string {
