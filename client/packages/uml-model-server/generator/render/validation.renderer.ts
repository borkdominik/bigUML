 ...
 **********************************************************************************/
import { getDefinitionSourceFiles } from '@borkdominik-biguml/uml-language-tooling';
import { Eta } from 'eta';
...
export function renderValidation(extensionPath: string, defPath: string): { path: string; content: string }[] {
