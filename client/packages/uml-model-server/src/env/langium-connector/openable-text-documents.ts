...
> extends TextDocuments<T> {
    ...
    public notifyDidCloseTextDocument(event: DidCloseTextDocumentParams, deleteFromSyncedDocuments: boolean = false): void {
    ...
    public notifyDidOpenTextDocument(event: DidOpenTextDocumentParams, client?: string): void {
        ...
        const syncedDocument = this.__syncedDocuments.get(td.uri);
