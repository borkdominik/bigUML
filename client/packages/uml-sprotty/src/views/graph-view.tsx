...
import { SGraphView } from "@eclipse-glsp/client";
import { injectable } from "inversify";
import { VNode } from "snabbdom";
import { RenderingContext, SGraph, svg } from "sprotty/lib";
...
@injectable()
export class UmlGraphView<IRenderingArgs> extends SGraphView<IRenderingArgs> {
    protected renderAdditionals(context: RenderingContext): VNode[] {
        const directedEdgeAdds: any = ([<defs>
            <marker id="marker-triangle" viewBox="0 0 10 10" refX="10" refY="5" markerUnits="strokeWidth" markerWidth="10"
                markerHeight="10" orient="auto-start-reverse">
                <path d="M 0 0 L 10 5 L 0 10 z" fill="var(--uml-edge)"/>
            </marker>
            <marker id="marker-triangle-empty" viewBox="0 0 10 10" refX="10" refY="5" markerUnits="strokeWidth" markerWidth="10"
                markerHeight="10" orient="auto-start-reverse">
                <path d="M 0 0 L 10 5 L 0 10 z" stroke="var(--uml-edge)" fill="var(--theia-editor-background)"/>
            </marker>
            <marker id="marker-tent" viewBox="0 0 10 10" refX="10" refY="5" markerUnits="strokeWidth" markerWidth="10"
                markerHeight="10" orient="auto-start-reverse">
                <path d="M 0 0 L 10 5 L 0 10" stroke="var(--uml-edge)" fill="var(--theia-editor-background)"/>
            </marker>
            <marker id="marker-diamond" viewBox="0 0 20 10" refX="20" refY="5" markerUnits="strokeWidth"
                markerWidth="20" markerHeight="10" orient="auto-start-reverse">
                <path d="M 0 5 L 10 10 L 20 5 L 10 0 L 0 5 z" fill="var(--uml-edge)"/>
            </marker>
            <marker id="marker-diamond-empty" viewBox="0 0 20 10" refX="20" refY="5" markerUnits="strokeWidth"
                markerWidth="20" markerHeight="10" orient="auto-start-reverse">
