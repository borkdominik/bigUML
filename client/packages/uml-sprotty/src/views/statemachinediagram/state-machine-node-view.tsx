...
export class StateMachineNodeView extends RectangularNodeView {
    render(node: LabeledNode, context: RenderingContext): VNode {
        ...
        const stateMachineNode: any = (<g class-node={true} class-selected={node.selected} class-mouseover={node.hoverFeedback}>
            <defs>
            ...
            <rect x={0} y={0} rx={10} ry={10} width={Math.max(0, node.bounds.width)}
