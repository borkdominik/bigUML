...
import { noBounds, toolPaletteItem, withDefaults } from '@borkdominik-biguml/uml-glsp-server/generator';
import { astType, crossReference, dynamicProperty, path, root } from '@borkdominik-biguml/uml-language-tooling';
