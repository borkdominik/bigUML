...
- contribution for local label search & replace of GLSP labels
- Literature survey on model search and query
- Concept for defining queries and visualizing matches in GLSP

---

## 1. Current Architecture

### 1.1 Existing Search — `big-advancedsearch`

The search package is located at [packages/big-advancedsearch/](packages/big-advancedsearch/) and already provides a pattern-matching search across UML model elements. Understanding it is the foundation for all extensions.
...
### 1.2 SVG Rendering — `big-minimap` + `big-revision-management`
...
### 1.3 Label Editing & Model Mutation
...
### 1.4 GLSP Client — Diagram Rendering
...
## 2. Feature: SVG Preview of Search Results
...
## 3. Feature: Text-Based Queries for Graphical Elements
...
## 4. Feature: Replace Functionality
...
1. Study how `big-revision-management` requests and displays SVG (see §1.2)
...
1. Survey existing model query approaches (see §3 research topics)
