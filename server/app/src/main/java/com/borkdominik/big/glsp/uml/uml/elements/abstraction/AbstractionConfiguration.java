...
public class AbstractionConfiguration extends BGBaseEdgeConfiguration {
   protected final String typeId = UMLTypes.ABSTRACTION.prefix(representation);

   @Inject
   public AbstractionConfiguration(@Assisted final Enumerator representation,
