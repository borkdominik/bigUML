...
public class ActivityConfiguration extends BGBaseNodeConfiguration {
   protected final String typeId = UMLTypes.ACTIVITY.prefix(representation);

   @Inject
   public ActivityConfiguration(@Assisted final Enumerator representation,
