...
import com.borkdominik.big.glsp.uml.uml.elements.activity_partition.gmodel.ActivityPartitionGModelMapper;
...
public class ActivityPartitionElementManifest extends BGEMFNodeElementManifest {
   public ActivityPartitionElementManifest(final BGRepresentationManifest manifest) {
      super(manifest, Set.of(UMLTypes.ACTIVITY_PARTITION));
   }

   @Override
   protected void configureElement() {
      bindGModelMapper(ActivityPartitionGModelMapper.class);
      bindConfiguration(ActivityPartitionConfiguration.class);
      bindCreateHandler(ActivityPartitionOperationHandler.class);
