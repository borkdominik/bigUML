...
public class ArtifactConfiguration extends BGBaseNodeConfiguration {
   protected final String typeId = UMLTypes.ARTIFACT.prefix(representation);

   @Inject
   public ArtifactConfiguration(@Assisted final Enumerator representation,
      ...
      return Set.of(
         new ShapeTypeHint(typeId, true, true, true, false,
            elementConfig().existingConfigurationTypeIds(
               Set.of(UMLTypes.PROPERTY, UMLTypes.OPERATION, UMLTypes.DEPLOYMENT_SPECIFICATION))));
   }
