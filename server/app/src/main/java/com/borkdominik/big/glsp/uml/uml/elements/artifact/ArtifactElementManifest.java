...
import com.borkdominik.big.glsp.uml.uml.elements.artifact.gmodel.ArtifactGModelMapper;
...
public class ArtifactElementManifest extends BGEMFNodeElementManifest {
   public ArtifactElementManifest(final BGRepresentationManifest manifest) {
      super(manifest, Set.of(UMLTypes.ARTIFACT));
   }

   @Override
   protected void configureElement() {
      bindGModelMapper(ArtifactGModelMapper.class);
      bindConfiguration(ArtifactConfiguration.class);
      bindCreateHandler(ArtifactOperationHandler.class);
