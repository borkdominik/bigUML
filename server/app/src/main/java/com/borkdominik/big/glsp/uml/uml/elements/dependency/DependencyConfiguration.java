...
public class DependencyConfiguration extends BGBaseEdgeConfiguration {
   protected final String typeId = UMLTypes.DEPENDENCY.prefix(representation);

   @Inject
   public DependencyConfiguration(@Assisted final Enumerator representation,
