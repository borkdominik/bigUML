...
public class DeploymentSpecificationConfiguration extends BGBaseNodeConfiguration {
   protected final String typeId = UMLTypes.DEPLOYMENT_SPECIFICATION.prefix(representation);

   @Inject
   public DeploymentSpecificationConfiguration(@Assisted final Enumerator representation,
   ...
   public Set<ShapeTypeHint> getShapeTypeHints() {
      return Set.of(
         new ShapeTypeHint(typeId, true, true, true, false,
            elementConfig()
               .existingConfigurationTypeIds(Set.of(UMLTypes.PROPERTY, UMLTypes.OPERATION, UMLTypes.ARTIFACT))));
   }
