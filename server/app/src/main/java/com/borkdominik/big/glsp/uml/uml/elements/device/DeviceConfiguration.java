...
public class DeviceConfiguration extends BGBaseNodeConfiguration {
   protected final String typeId = UMLTypes.DEVICE.prefix(representation);

   @Inject
   public DeviceConfiguration(@Assisted final Enumerator representation,
      ...
      return Set.of(
         new ShapeTypeHint(typeId, true, true, true, false,
            elementConfig().existingConfigurationTypeIds(
               Set.of(UMLTypes.DEPLOYMENT_SPECIFICATION, UMLTypes.EXECUTION_ENVIRONMENT, UMLTypes.NODE))));
   }
