...
public class DeviceOperationHandler extends BGEMFNodeOperationHandler<Enumeration, Package> {

   @Inject
   public DeviceOperationHandler(@Assisted final Enumerator representation,
