...
public class EnumerationLiteralConfiguration extends BGBaseNodeConfiguration {
   protected final String typeId = UMLTypes.ENUMERATION_LITERAL.prefix(representation);

   @Inject
   public EnumerationLiteralConfiguration(@Assisted final Enumerator representation,
