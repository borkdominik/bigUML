...
public class GeneralizationConfiguration extends BGBaseEdgeConfiguration {
   protected final String typeId = UMLTypes.GENERALIZATION.prefix(representation);

   @Inject
   public GeneralizationConfiguration(@Assisted final Enumerator representation,
