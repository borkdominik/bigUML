...
public class InterfaceRealizationConfiguration extends BGBaseEdgeConfiguration {
   protected final String typeId = UMLTypes.INTERFACE_REALIZATION.prefix(representation);

   @Inject
   public InterfaceRealizationConfiguration(@Assisted final Enumerator representation,
   ...
   public Set<EdgeTypeHint> getEdgeTypeHints() {
      return Set.of(
         new EdgeTypeHint(typeId, true, true, true,
            ...
            elementConfig().existingConfigurationTypeIds(Set.of(UMLTypes.INTERFACE))));
   }
