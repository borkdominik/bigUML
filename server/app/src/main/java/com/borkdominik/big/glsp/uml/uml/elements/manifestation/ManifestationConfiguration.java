...
public class ManifestationConfiguration extends BGBaseEdgeConfiguration {
   protected final String typeId = UMLTypes.MANIFESTATION.prefix(representation);

   @Inject
   public ManifestationConfiguration(@Assisted final Enumerator representation,
   ...
   public Set<EdgeTypeHint> getEdgeTypeHints() {
      return Set.of(
         new EdgeTypeHint(typeId, true, true, true,
            elementConfig().existingConfigurationTypeIds(Set.of(UMLTypes.ARTIFACT)),
            elementConfig().existingConfigurationTypeIds(Set.of(UMLTypes.ARTIFACT,
               UMLTypes.DEVICE,
