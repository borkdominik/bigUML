...
public class ModelOperationHandler extends BGEMFNodeOperationHandler<Enumeration, Package> {

   @Inject
   public ModelOperationHandler(@Assisted final Enumerator representation,
