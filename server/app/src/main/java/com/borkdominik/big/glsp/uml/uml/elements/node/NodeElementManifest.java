 ...
 ********************************************************************************/
package com.borkdominik.big.glsp.uml.uml.elements.node;
...
import com.borkdominik.big.glsp.uml.uml.elements.node.gmodel.NodeGModelMapper;

public class NodeElementManifest extends BGEMFNodeElementManifest {
   public NodeElementManifest(final BGRepresentationManifest manifest) {
      super(manifest, Set.of(UMLTypes.NODE));
   }

   @Override
   protected void configureElement() {
      bindGModelMapper(NodeGModelMapper.class);
      bindConfiguration(NodeConfiguration.class);
      bindCreateHandler(NodeOperationHandler.class);
