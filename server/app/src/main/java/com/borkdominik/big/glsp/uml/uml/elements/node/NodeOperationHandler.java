...
public class NodeOperationHandler extends BGEMFNodeOperationHandler<Node, Element> {

   @Inject
   public NodeOperationHandler(@Assisted final Enumerator representation,
   ...
   @Override
   protected BGCreateSemanticCommand<Node> createSemanticCommand(
      ...
      if (parent instanceof Package p) {
         var argument = CreatePackagableElementCommand.Argument
            .<Node> createPackageableElementArgumentBuilder()
            .supplier((x) -> UMLFactory.eINSTANCE.createNode())
            .build();
         ...
         var argument = CreateNestedNodeCommand.Argument
            .<Node> createNestedNodeArgumentBuilder()
            .supplier((x) -> UMLFactory.eINSTANCE.createNode())
            .build();
