...
public class OperationConfiguration extends BGBaseNodeConfiguration {
   protected final String typeId = UMLTypes.OPERATION.prefix(representation);

   @Inject
   public OperationConfiguration(@Assisted final Enumerator representation,
   ...
   public Set<ShapeTypeHint> getShapeTypeHints() {
      return Set.of(
         new ShapeTypeHint(typeId, false, true, false, false,
            elementConfig().existingConfigurationTypeIds(Set.of(UMLTypes.PARAMETER))));
   }
