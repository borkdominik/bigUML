...
public class ParameterConfiguration extends BGBaseNodeConfiguration {
   protected final String typeId = UMLTypes.PARAMETER.prefix(representation);

   @Inject
   public ParameterConfiguration(@Assisted final Enumerator representation,
