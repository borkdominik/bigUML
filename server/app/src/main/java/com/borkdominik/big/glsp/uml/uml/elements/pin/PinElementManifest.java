...
import com.borkdominik.big.glsp.uml.uml.elements.pin.gmodel.PinGModelMapper;

public class PinElementManifest extends BGEMFNodeElementManifest {
   public PinElementManifest(final BGRepresentationManifest manifest) {
   ...
   protected void configureElement() {
      bindGModelMapper(PinGModelMapper.class);
      bindConfiguration(PinConfiguration.class);
      bindCreateHandler(PinOperationHandler.class);
