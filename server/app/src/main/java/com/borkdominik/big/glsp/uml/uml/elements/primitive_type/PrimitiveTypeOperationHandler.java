...
public class PrimitiveTypeOperationHandler extends BGEMFNodeOperationHandler<PrimitiveType, Package> {

   @Inject
   public PrimitiveTypeOperationHandler(@Assisted final Enumerator representation,
   ...
   @Override
   protected BGCreateNodeSemanticCommand<PrimitiveType, Package, ?> createSemanticCommand(
      ...
      var argument = CreatePackagableElementCommand.Argument
         ...
         .supplier((x) -> UMLFactory.eINSTANCE.createPrimitiveType())
         .build();
