...
public class GStateBuilder<TOrigin extends State> extends GCNodeBuilder<TOrigin> {

   public GStateBuilder(final GCModelContext context, final TOrigin source, final String type) {
   ...
   protected GNode createRootGModel() {
      return new GNodeBuilder(type)
         ...
         .addCssClass(BGCoreCSS.NO_STROKE)
         .build();
   }
