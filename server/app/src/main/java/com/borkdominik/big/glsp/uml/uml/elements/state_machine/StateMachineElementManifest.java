...
import com.borkdominik.big.glsp.uml.uml.elements.state_machine.gmodel.StateMachineGModelMapper;

public class StateMachineElementManifest extends BGEMFNodeElementManifest {
   public StateMachineElementManifest(final BGRepresentationManifest manifest) {
      super(manifest, Set.of(UMLTypes.STATE_MACHINE));
   }

   @Override
   protected void configureElement() {
      bindGModelMapper(StateMachineGModelMapper.class);
      bindConfiguration(StateMachineConfiguration.class);
      bindCreateHandler(StateMachineOperationHandler.class);
