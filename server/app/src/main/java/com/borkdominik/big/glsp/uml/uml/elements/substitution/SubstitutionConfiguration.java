...
public class SubstitutionConfiguration extends BGBaseEdgeConfiguration {
   protected final String typeId = UMLTypes.SUBSTITUTION.prefix(representation);

   @Inject
   public SubstitutionConfiguration(@Assisted final Enumerator representation,
