...
public class TransitionConfiguration extends BGBaseEdgeConfiguration {
   protected final String typeId = UMLTypes.TRANSITION.prefix(representation);

   @Inject
   public TransitionConfiguration(@Assisted final Enumerator representation,
