...
public class UsageConfiguration extends BGBaseEdgeConfiguration {
   protected final String typeId = UMLTypes.USAGE.prefix(representation);

   @Inject
   public UsageConfiguration(@Assisted final Enumerator representation,
