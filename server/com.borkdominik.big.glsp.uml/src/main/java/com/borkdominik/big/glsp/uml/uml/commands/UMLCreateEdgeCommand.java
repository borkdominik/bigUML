...
public class UMLCreateEdgeCommand<TElement extends EObject, TSource extends EObject, TTarget extends EObject, TArgument extends UMLCreateEdgeCommand.Argument<TElement, TSource, TTarget>> extends BGCreateEdgeSemanticCommand<TElement, TSource, TTarget, TArgument> {
   ...
   public static class Argument<TElement, TSource, TTarget> {
      ...
      public static abstract class ArgumentBuilder<TElement, TSource, TTarget, C extends UMLCreateEdgeCommand.Argument<TElement, TSource, TTarget>, B extends UMLCreateEdgeCommand.Argument.ArgumentBuilder<TElement, TSource, TTarget, C, B>> {
         ...
         public java.lang.String toString() {
            return "UMLCreateEdgeCommand.Argument.ArgumentBuilder(supplier=" + this.supplier + ", initName$value=" + this.initName$value + ")";
         }
      }

      private static final class ArgumentBuilderImpl<TElement, TSource, TTarget> extends UMLCreateEdgeCommand.Argument.ArgumentBuilder<TElement, TSource, TTarget, UMLCreateEdgeCommand.Argument<TElement, TSource, TTarget>, UMLCreateEdgeCommand.Argument.ArgumentBuilderImpl<TElement, TSource, TTarget>> {
      ...
      protected Argument(final UMLCreateEdgeCommand.Argument.ArgumentBuilder<TElement, TSource, TTarget, ?, ?> b) {
         ...
         if (b.initName$set) this.initName = b.initName$value;
          else this.initName = UMLCreateEdgeCommand.Argument.<TElement, TSource, TTarget>$default$initName();
      }
   ...
   public UMLCreateEdgeCommand(final BGEMFCommandContext context, final TSource source, final TTarget target, final TArgument argument) {
   ...
   protected TElement createElement(final TSource source, final TTarget target, final TArgument argument) {
      ...
      if (element == null) {
         throw new GLSPServerException(String.format("[%s] Failed to create child for source %s and target %s", this.getClass().getSimpleName(), source.getClass().getSimpleName(), target.getClass().getSimpleName()));
      }
