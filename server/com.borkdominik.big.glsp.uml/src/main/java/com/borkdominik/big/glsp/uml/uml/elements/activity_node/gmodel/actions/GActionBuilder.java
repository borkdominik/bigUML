 ...
 ********************************************************************************/
package com.borkdominik.big.glsp.uml.uml.elements.activity_node.gmodel.actions;
...
public final class GActionBuilder<TOrigin extends Action> extends GCNodeBuilder<TOrigin> {

   public GActionBuilder(final GCModelContext context, final TOrigin origin, final String type) {
