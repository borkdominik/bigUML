 ...
 ********************************************************************************/
package com.borkdominik.big.glsp.uml.uml.elements.activity_node.gmodel.object_nodes;
...
public final class GObjectNodeBuilder<TOrigin extends ObjectNode> extends GCNodeBuilder<TOrigin> {

   public GObjectNodeBuilder(final GCModelContext context, final TOrigin origin, final String type) {
