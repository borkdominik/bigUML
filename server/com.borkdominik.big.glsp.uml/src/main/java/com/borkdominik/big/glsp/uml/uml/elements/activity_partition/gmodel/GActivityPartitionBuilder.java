...
public final class GActivityPartitionBuilder<TOrigin extends ActivityPartition> extends GCNodeBuilder<TOrigin> {

   public GActivityPartitionBuilder(final GCModelContext context, final TOrigin origin, final String type) {
   ...
   protected GCProvider createBody(final GCModelList<?, ?> root) {
      ...
      list.addAll(providersOf(this.origin.getSubpartitions()));
