...
public class DataTypeConfiguration extends BGBaseNodeConfiguration {
   protected final String typeId = UMLTypes.DATA_TYPE.prefix(representation);

   @Inject
   public DataTypeConfiguration(@Assisted final Enumerator representation,
