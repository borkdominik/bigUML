...
import com.borkdominik.big.glsp.uml.uml.elements.data_type.gmodel.DataTypeGModelMapper;
...
public class DataTypeElementManifest extends BGEMFNodeElementManifest {
   public DataTypeElementManifest(final BGRepresentationManifest manifest) {
      super(manifest, Set.of(UMLTypes.DATA_TYPE));
   }

   @Override
   protected void configureElement() {
      bindGModelMapper(DataTypeGModelMapper.class);
      bindConfiguration(DataTypeConfiguration.class);
      bindCreateHandler(DataTypeOperationHandler.class);
