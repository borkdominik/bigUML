...
import com.borkdominik.big.glsp.uml.uml.elements.deployment.gmodel.DeploymentGModelMapper;
import com.borkdominik.big.glsp.uml.uml.elements.named_element.NamedElementPropertyProvider;

public class DeploymentElementManifest extends BGEMFEdgeElementManifest {
   public DeploymentElementManifest(final BGRepresentationManifest manifest) {
      super(manifest, Set.of(UMLTypes.DEPLOYMENT));
   }

   @Override
   protected void configureElement() {
      bindGModelMapper(DeploymentGModelMapper.class);
      bindConfiguration(DeploymentConfiguration.class);
      bindCreateHandler(DeploymentOperationHandler.class);
