...
import com.borkdominik.big.glsp.uml.uml.elements.deployment_specification.gmodel.DeploymentSpecificationGModelMapper;
...
public class DeploymentSpecificationElementManifest extends BGEMFNodeElementManifest {
   public DeploymentSpecificationElementManifest(final BGRepresentationManifest manifest) {
      super(manifest, Set.of(UMLTypes.DEPLOYMENT_SPECIFICATION));
   }

   @Override
   protected void configureElement() {
      bindGModelMapper(DeploymentSpecificationGModelMapper.class);
      bindConfiguration(DeploymentSpecificationConfiguration.class);
      bindCreateHandler(DeploymentSpecificationOperationHandler.class);
