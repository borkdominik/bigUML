...
public class EnumerationConfiguration extends BGBaseNodeConfiguration {
   protected final String typeId = UMLTypes.ENUMERATION.prefix(representation);

   @Inject
   public EnumerationConfiguration(@Assisted final Enumerator representation,
   ...
   public Set<ShapeTypeHint> getShapeTypeHints() {
      return Set.of(
         new ShapeTypeHint(typeId, true, true, true, false,
            elementConfig().existingConfigurationTypeIds(Set.of(UMLTypes.ENUMERATION_LITERAL))));
   }
