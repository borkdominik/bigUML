...
import com.borkdominik.big.glsp.uml.uml.elements.enumeration.features.EnumerationPropertyProvider;
import com.borkdominik.big.glsp.uml.uml.elements.enumeration.gmodel.EnumerationGModelMapper;
...
public class EnumerationElementManifest extends BGEMFNodeElementManifest {
   public EnumerationElementManifest(final BGRepresentationManifest manifest) {
      super(manifest, Set.of(UMLTypes.ENUMERATION));
   }

   @Override
   protected void configureElement() {
      bindGModelMapper(EnumerationGModelMapper.class);
      bindConfiguration(EnumerationConfiguration.class);
      bindCreateHandler(EnumerationOperationHandler.class);
      ...
      bindPropertyPalette(BGPropertyPaletteContribution.Options.builder()
         .propertyProviders(Set.of(
            ...
            EnumerationPropertyProvider.class)));
   }
}
