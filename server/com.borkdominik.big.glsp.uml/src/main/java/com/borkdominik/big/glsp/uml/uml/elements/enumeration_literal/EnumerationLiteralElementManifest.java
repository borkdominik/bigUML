...
import com.borkdominik.big.glsp.uml.uml.elements.enumeration_literal.gmodel.EnumerationLiteralGModelMapper;
...
public class EnumerationLiteralElementManifest extends BGEMFNodeElementManifest {
   public EnumerationLiteralElementManifest(final BGRepresentationManifest manifest) {
      super(manifest, Set.of(UMLTypes.ENUMERATION_LITERAL));
   }

   @Override
   protected void configureElement() {
      bindGModelMapper(EnumerationLiteralGModelMapper.class);
      bindConfiguration(EnumerationLiteralConfiguration.class);
      bindCreateHandler(EnumerationLiteralOperationHandler.class);
