...
public class ExecutionEnvironmentConfiguration extends BGBaseNodeConfiguration {
   protected final String typeId = UMLTypes.DEPLOYMENT_SPECIFICATION.prefix(representation);

   @Inject
   public ExecutionEnvironmentConfiguration(@Assisted final Enumerator representation,
      ...
      return Set.of(
         new ShapeTypeHint(typeId, true, true, true, false,
            elementConfig().existingConfigurationTypeIds(
               Set.of(UMLTypes.EXECUTION_ENVIRONMENT, UMLTypes.ARTIFACT, UMLTypes.DEPLOYMENT_SPECIFICATION))));
   }
