...
public final class GExecutionEnvironmentBuilder<TOrigin extends ExecutionEnvironment>
   extends GNodeBuilder<TOrigin> {

   public GExecutionEnvironmentBuilder(final GCModelContext context, final TOrigin origin, final String type) {
   ...
   protected GCProvider createHeader(final GCModelList<?, ?> container) {
      var namedElementOptions = GCNamedElement.Options.builder()
         .container(container)
         .prefix((BGQuotationMark.quoteDoubleAngle("Execution Environment")))
         .build();
