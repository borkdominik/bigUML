 ...
 ********************************************************************************/
package com.borkdominik.big.glsp.uml.uml.elements.generalization.gmodel;
...
public class GGeneralizationBuilder<TOrigin extends Generalization> extends GCEdgeBuilder<TOrigin> {
   ...
   public GGeneralizationBuilder(final GCModelContext context, final TOrigin origin, final String type) {
   ...
   protected List<String> getRootGModelCss() {
      return StreamUtils.concat(super.getDefaultCss(), List.of(BGCoreCSS.Marker.TRIANGLE_EMPTY.end()));
   }
