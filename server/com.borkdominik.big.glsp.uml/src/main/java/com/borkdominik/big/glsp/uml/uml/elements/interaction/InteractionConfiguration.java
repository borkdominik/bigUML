...
public class InteractionConfiguration extends BGBaseNodeConfiguration {
   protected final String typeId = UMLTypes.INTERACTION.prefix(representation);

   @Inject
   public InteractionConfiguration(@Assisted final Enumerator representation,
   ...
   public Set<ShapeTypeHint> getShapeTypeHints() {
      return Set.of(
         new ShapeTypeHint(typeId, true, true, true, false,
            elementConfig().existingConfigurationTypeIds(Set.of(UMLTypes.LIFELINE))));
   }
