...
import com.borkdominik.big.glsp.uml.uml.elements.interaction.gmodel.InteractionGModelMapper;
...
public class InteractionElementManifest extends BGEMFNodeElementManifest {
   public InteractionElementManifest(final BGRepresentationManifest manifest) {
      super(manifest, Set.of(UMLTypes.INTERACTION));
   }

   @Override
   protected void configureElement() {
      bindGModelMapper(InteractionGModelMapper.class);
      bindConfiguration(InteractionConfiguration.class);
      bindCreateHandler(InteractionOperationHandler.class);
