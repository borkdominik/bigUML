...
public class InterfaceConfiguration extends BGBaseNodeConfiguration {
   protected final String typeId = UMLTypes.INTERFACE.prefix(representation);

   @Inject
   public InterfaceConfiguration(@Assisted final Enumerator representation,
