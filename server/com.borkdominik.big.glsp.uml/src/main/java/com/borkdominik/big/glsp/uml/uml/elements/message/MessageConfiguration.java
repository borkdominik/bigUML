...
public class MessageConfiguration extends BGBaseEdgeConfiguration {
   protected final String typeId = UMLTypes.MESSAGE.prefix(representation);

   @Inject
   public MessageConfiguration(@Assisted final Enumerator representation,
