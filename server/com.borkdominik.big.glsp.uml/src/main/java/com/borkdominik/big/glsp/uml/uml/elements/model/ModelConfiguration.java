...
public class ModelConfiguration extends BGBaseNodeConfiguration {
   protected final String typeId = UMLTypes.MODEL.prefix(representation);

   @Inject
   public ModelConfiguration(@Assisted final Enumerator representation,
   ...
   public Set<ShapeTypeHint> getShapeTypeHints() {
      return Set.of(
         new ShapeTypeHint(typeId, true, true, true, false,
            elementConfig().existingConfigurationTypeIds(Set.of(UMLTypes.MODEL,
               UMLTypes.ARTIFACT,
               UMLTypes.DEVICE,
