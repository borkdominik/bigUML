...
public class PackageMergeConfiguration extends BGBaseEdgeConfiguration {
   protected final String typeId = UMLTypes.PACKAGE_MERGE.prefix(representation);

   @Inject
   public PackageMergeConfiguration(@Assisted final Enumerator representation,
