...
import com.borkdominik.big.glsp.uml.uml.elements.activity_node.gmodel.GActivityNodeBuilder;
...
public class PinGModelMapper extends BGEMFElementGModelMapper<Pin, GNode> {
   ...
   public GNode map(final Pin source) {
      ...
      return new GActivityNodeBuilder<>(gcmodelContext, source, UMLTypes.PIN.prefix(representation))
         .buildGModel();
   }
}
