...
public class PrimitiveTypeConfiguration extends BGBaseNodeConfiguration {
   protected final String typeId = UMLTypes.PRIMITIVE_TYPE.prefix(representation);

   @Inject
   public PrimitiveTypeConfiguration(@Assisted final Enumerator representation,
   ...
   public Set<ShapeTypeHint> getShapeTypeHints() {
      return Set.of(
         new ShapeTypeHint(typeId, true, true, true, false,
            elementConfig().existingConfigurationTypeIds(Set.of(UMLTypes.PROPERTY,
               UMLTypes.OPERATION))));
   }
}
