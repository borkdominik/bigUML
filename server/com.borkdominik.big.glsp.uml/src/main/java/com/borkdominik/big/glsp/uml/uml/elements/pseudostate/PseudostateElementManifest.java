...
import com.borkdominik.big.glsp.uml.uml.elements.pseudostate.gmodel.PseudostateGModelMapper;

public class PseudostateElementManifest extends BGEMFNodeElementManifest {
   public PseudostateElementManifest(final BGRepresentationManifest manifest) {
      super(manifest, Set.of(UMLTypes.PSEUDOSTATE, UMLTypes.CHOICE, UMLTypes.DEEP_HISTORY, UMLTypes.FORK,
         UMLTypes.INITIAL_STATE, UMLTypes.JOIN, UMLTypes.SHALLOW_HISTORY));
   }

   @Override
   protected void configureElement() {
      bindGModelMapper(PseudostateGModelMapper.class);
      bindConfiguration(PseudostateConfiguration.class);
      bindCreateHandler(PseudostateOperationHandler.class);
