...
public class RealizationConfiguration extends BGBaseEdgeConfiguration {
   protected final String typeId = UMLTypes.REALIZATION.prefix(representation);

   @Inject
   public RealizationConfiguration(@Assisted final Enumerator representation,
