...
public class StateConfiguration extends BGBaseNodeConfiguration {
   protected final String typeId = UMLTypes.STATE.prefix(representation);

   @Inject
   public StateConfiguration(@Assisted final Enumerator representation,
   ...
   public Set<ShapeTypeHint> getShapeTypeHints() {
      return Set.of(
         new ShapeTypeHint(typeId, true, true, true, false,
            elementConfig().existingConfigurationTypeIds(Set.of(UMLTypes.STATE, UMLTypes.REGION))));
   }
}
