...
import com.borkdominik.big.glsp.uml.uml.elements.substitution.gmodel.SubstitutionGModelMapper;

public class SubstitutionElementManifest extends BGEMFEdgeElementManifest {
   public SubstitutionElementManifest(final BGRepresentationManifest manifest) {
      super(manifest, Set.of(UMLTypes.SUBSTITUTION));
   }

   @Override
   protected void configureElement() {
      bindGModelMapper(SubstitutionGModelMapper.class);
      bindConfiguration(SubstitutionConfiguration.class);
      bindCreateHandler(SubstitutionOperationHandler.class);
