...
public class DiagramReconnectEdgeHandlerRegistry
   extends DiagramClassRegistry<Class<? extends EObject>, DiagramReconnectEdgeHandler<? extends EObject>> {

   @Inject
   public DiagramReconnectEdgeHandlerRegistry(
      final Map<Representation, Set<DiagramReconnectEdgeHandler<? extends EObject>>> handlers) {
