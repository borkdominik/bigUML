...
public interface DiagramDeleteHandlerContribution
   extends ContributionBinderSupplier, ContributionIdSupplier, ContributionRepresentationSupplier {

   default void contributeDiagramDeleteHandlers(
      final Consumer<Multibinder<DiagramDeleteHandler<? extends EObject>>> consumer) {
