...
public final class ElementReferencePropertyItemNoCreate extends ElementPropertyItem {
   ...
   public ElementReferencePropertyItemNoCreate(final String elementId, final String propertyId, final String label,
      final List<Reference> references, final List<CreateReference> creates, final Boolean isOrderable) {
      super(elementId, propertyId, ElementPropertyType.CHOICEREFERENCE);
