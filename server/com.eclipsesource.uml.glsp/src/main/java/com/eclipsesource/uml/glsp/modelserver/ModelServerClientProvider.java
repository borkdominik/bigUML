...
public class ModelServerClientProvider {
   private UmlModelServerClient modelServerClient;

   public Optional<UmlModelServerClient> get() {
      return Optional.ofNullable(modelServerClient);
   }

   public void setModelServerClient(final UmlModelServerClient modelServerClient) {
