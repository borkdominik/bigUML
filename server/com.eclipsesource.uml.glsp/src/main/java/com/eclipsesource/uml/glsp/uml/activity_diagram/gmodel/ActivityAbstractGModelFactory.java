...
public abstract class ActivityAbstractGModelFactory<T extends EObject, E extends GModelElement> {

   protected UmlModelState modelState;

   public ActivityAbstractGModelFactory(final UmlModelState modelState) {
