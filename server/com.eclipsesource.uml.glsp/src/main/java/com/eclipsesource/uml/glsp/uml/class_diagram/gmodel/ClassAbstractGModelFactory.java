...
public abstract class ClassAbstractGModelFactory<T extends EObject, E extends GModelElement> {

   protected UmlModelState modelState;

   public ClassAbstractGModelFactory(final UmlModelState modelState) {
