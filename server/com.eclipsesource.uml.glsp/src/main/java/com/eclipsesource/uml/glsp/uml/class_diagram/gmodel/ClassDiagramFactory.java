...
public abstract class ClassDiagramFactory extends ClassAbstractGModelFactory<EObject, GModelElement> {
   ...
   public ClassDiagramFactory(final UmlModelState modelState) {
      super(modelState);
      // COMMONS
