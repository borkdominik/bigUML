...
public final class LabelMultiplicitySuffix extends BaseSuffixIdAppender {
   public static final String SUFFIX = "_label_multiplicity";

   public LabelMultiplicitySuffix() {
      super(SUFFIX);
   }
}
