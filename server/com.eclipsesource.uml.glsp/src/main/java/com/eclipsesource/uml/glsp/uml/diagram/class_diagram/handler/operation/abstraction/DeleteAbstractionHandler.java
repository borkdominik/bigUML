...
public final class DeleteAbstractionHandler extends BaseDeleteElementHandler<Abstraction> {

   @Override
   protected CCommand createCommand(final Abstraction element) {
      return DeleteAbstractionContribution.create(element);
   }
}
