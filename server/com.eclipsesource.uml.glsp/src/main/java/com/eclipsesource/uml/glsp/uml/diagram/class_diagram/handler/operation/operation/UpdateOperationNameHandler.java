...
public final class UpdateOperationNameHandler extends UpdateNamedElementNameHandler<Operation> {
   public UpdateOperationNameHandler() {
      super(UmlClass_Operation.Property.NAME);
   }
