...
public class DeletePackageHandler extends BaseDeleteElementHandler<Package> {

   @Override
   protected CCommand command(final Package element) {
      return RemovePackageContribution.create(element);
   }
}
