...
public final class DeleteUsageHandler extends BaseDeleteElementHandler<Usage> {

   @Override
   protected CCommand createCommand(final Usage element) {
      return DeleteUsageContribution.create(element);
   }
}
