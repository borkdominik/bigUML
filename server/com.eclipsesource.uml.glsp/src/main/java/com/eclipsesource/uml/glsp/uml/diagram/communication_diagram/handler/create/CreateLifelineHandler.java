...
import com.eclipsesource.uml.glsp.uml.handler.create.CreateChildNodeHandler;
...
public class CreateLifelineHandler
   ...
   @Override
   protected CompletableFuture<Response<String>> create(final Interaction container, final Optional<GPoint> location) {
      return modelServerAccess
         .exec(AddLifelineContribution.create(
            container,
