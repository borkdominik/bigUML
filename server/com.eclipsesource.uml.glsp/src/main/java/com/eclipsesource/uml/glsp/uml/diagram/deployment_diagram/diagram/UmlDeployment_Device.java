...
public class UmlDeployment_Device {
      ...
      public Set<ShapeTypeHint> getShapeTypeHints() {
         return Set.of(
            new ShapeTypeHint(typeId(), true, true, true, false,
               List.of(
                  UmlDeployment_Device.typeId(), // only on lvl 1
                  UmlDeployment_DeploymentSpecification.typeId(), // only on lvl 1
                  UmlDeployment_ExecutionEnvironment.typeId(), // only on lvl 1
                  UmlDeployment_Node.typeId() // only on lvl 1
               )));
      }
   }
}
