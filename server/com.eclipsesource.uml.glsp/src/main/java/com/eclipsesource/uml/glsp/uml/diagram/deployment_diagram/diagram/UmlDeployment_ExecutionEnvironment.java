      ...
      public Set<ShapeTypeHint> getShapeTypeHints() {
         return Set.of(
            new ShapeTypeHint(typeId(), true, true, true, false,
               List.of(
                  UmlDeployment_Artifact.typeId(), // all levels of artifacts allowed
                  UmlDeployment_DeploymentSpecification.typeId(), // only on level 1
                  UmlDeployment_ExecutionEnvironment.typeId() // only on level 1
               )));
      }
   }
}
