...
public class UmlDeployment_Model {
      ...
      public Set<ShapeTypeHint> getShapeTypeHints() {
         return Set.of(
            new ShapeTypeHint(typeId(), true, true, true, false,
               List.of(
                  UmlDeployment_Artifact.typeId(), // behavior deviates from original artifact only on lvl 1 allowed see
                  UmlDeployment_Device.typeId(), // see device behavior
                  UmlDeployment_DeploymentSpecification.typeId(), // see Deployment Sepc behavior
                  UmlDeployment_ExecutionEnvironment.typeId(), // see Execution Environment behavior
