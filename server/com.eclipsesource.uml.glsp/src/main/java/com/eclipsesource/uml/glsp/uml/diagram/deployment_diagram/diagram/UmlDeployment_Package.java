...
public class UmlDeployment_Package {
      ...
      public Set<ShapeTypeHint> getShapeTypeHints() {
         return Set.of(
            new ShapeTypeHint(typeId(), true, true, true, false,
               List.of(
                  UmlDeployment_Artifact.typeId(), // only on lvl 1 no children allowed looks different
                  UmlDeployment_Device.typeId(), // same behavior as device
                  UmlDeployment_DeploymentSpecification.typeId(), // same behavior as DS
                  UmlDeployment_ExecutionEnvironment.typeId(), // same behavior as Execution Environment
                  UmlDeployment_Model.typeId(), // same behavior as Model
                  UmlDeployment_Node.typeId(), // same behavior as Node
                  UmlDeployment_Package.typeId() // same behavior as Package
               )));
