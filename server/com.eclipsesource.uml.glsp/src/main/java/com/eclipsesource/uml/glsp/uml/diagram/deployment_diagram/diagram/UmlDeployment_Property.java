...
public class UmlDeployment_Property {
   public static String ID = org.eclipse.uml2.uml.Property.class.getSimpleName();

   public static String typeId() {
      return QualifiedUtil.representationTypeId(Representation.DEPLOYMENT, DefaultTypes.COMPARTMENT,
         ID);
   }

   public static class Label {
      public static String typeTypeId() {
         return QualifiedUtil.representationTypeId(Representation.DEPLOYMENT, DefaultTypes.LABEL,
            ID + "-type");
      }
