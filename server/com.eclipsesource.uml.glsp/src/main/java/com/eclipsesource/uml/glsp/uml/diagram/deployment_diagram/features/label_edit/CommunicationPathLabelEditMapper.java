...
public final class CommunicationPathLabelEditMapper extends BaseLabelEditMapper<CommunicationPath> {

   @Override
   public Optional<UpdateOperation> map(final ApplyLabelEditOperation operation) {
      var handler = getHandler(UpdateCommunicationPathHandler.class, operation);
