...
public final class DeploymentSpecificationLabelEditMapper extends BaseLabelEditMapper<DeploymentSpecification> {
   @Override
   public Optional<UpdateOperation> map(final ApplyLabelEditOperation operation) {
      var handler = getHandler(UpdateDeploymentSpecificationHandler.class, operation);
