...
public final class ExecutionEnvironmentLabelEditMapper extends BaseLabelEditMapper<ExecutionEnvironment> {
   @Override
   public Optional<UpdateOperation> map(final ApplyLabelEditOperation operation) {
      var handler = getHandler(UpdateExecutionEnvironmentHandler.class, operation);
