...
public final class ManifestationLabelEditMapper extends BaseLabelEditMapper<Manifestation> {

   @Override
   public Optional<UpdateOperation> map(final ApplyLabelEditOperation operation) {
      var handler = getHandler(UpdateManifestationHandler.class, operation);
