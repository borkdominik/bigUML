...
import com.eclipsesource.uml.modelserver.uml.diagram.deployment_diagram.commands.dependency.UpdateDependencyArgument;
...
public class DependencyPropertyMapper extends BaseDiagramElementPropertyMapper<Dependency> {
   ...
   public PropertyPalette map(final Dependency source) {
      ...
      var items = this.propertyBuilder(UmlDeployment_Dependency.Property.class, elementId)
         .text(UmlDeployment_Dependency.Property.NAME, "Name", source.getName())
         .items();
   ...
   public Optional<UpdateOperation> map(final UpdateElementPropertyAction action) {
      var property = getProperty(UmlDeployment_Dependency.Property.class, action);
