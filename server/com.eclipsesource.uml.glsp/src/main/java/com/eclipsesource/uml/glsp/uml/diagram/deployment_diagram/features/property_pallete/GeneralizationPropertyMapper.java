...
import com.eclipsesource.uml.modelserver.uml.diagram.deployment_diagram.commands.generalization.UpdateGeneralizationArgument;
...
public class GeneralizationPropertyMapper extends BaseDiagramElementPropertyMapper<Generalization> {
   ...
   public PropertyPalette map(final Generalization source) {
      ...
      var items = this.propertyBuilder(UmlDeployment_Generalization.Property.class, elementId)
         .bool(UmlDeployment_Generalization.Property.IS_SUBSTITUTABLE, "Is substitutable", source.isSubstitutable())
         .items();
   ...
   public Optional<UpdateOperation> map(final UpdateElementPropertyAction action) {
      var property = getProperty(UmlDeployment_Generalization.Property.class, action);
