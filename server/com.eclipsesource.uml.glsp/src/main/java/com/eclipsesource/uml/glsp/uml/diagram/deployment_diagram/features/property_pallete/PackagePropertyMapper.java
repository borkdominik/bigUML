...
public class PackagePropertyMapper extends BaseDiagramElementPropertyMapper<Package> {
   ...
   public PropertyPalette map(final Package source) {
      ...
      var items = this.propertyBuilder(UmlDeployment_Package.Property.class, elementId)
         .text(UmlDeployment_Package.Property.NAME, "Name", source.getName())
         .text(UmlDeployment_Package.Property.URI, "URI", source.getURI())
         .choice(UmlDeployment_Package.Property.VISIBILITY_KIND, "Visibility", VisibilityKindUtils.asChoices(),
   ...
   public Optional<UpdateOperation> map(final UpdateElementPropertyAction action) {
      var property = getProperty(UmlDeployment_Package.Property.class, action);
