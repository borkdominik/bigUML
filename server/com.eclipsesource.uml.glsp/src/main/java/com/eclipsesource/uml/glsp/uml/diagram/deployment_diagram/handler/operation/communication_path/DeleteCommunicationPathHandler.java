...
public final class DeleteCommunicationPathHandler extends BaseDeleteElementHandler<CommunicationPath> {

   @Override
   protected CCommand createCommand(final CommunicationPath element) {
      return DeleteCommunicationPathContribution.create(element);
   }
}
