...
public final class DeleteDeploymentHandler extends BaseDeleteElementHandler<Deployment> {

   @Override
   protected CCommand createCommand(final Deployment element) {
      return DeleteDeploymentContribution.create(element);
   }
}
