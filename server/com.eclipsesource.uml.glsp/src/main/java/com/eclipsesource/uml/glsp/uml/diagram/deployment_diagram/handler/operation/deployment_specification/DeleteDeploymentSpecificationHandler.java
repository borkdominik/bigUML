...
public final class DeleteDeploymentSpecificationHandler extends BaseDeleteElementHandler<DeploymentSpecification> {

   @Override
   protected CCommand createCommand(final DeploymentSpecification element) {
      return DeleteDeploymentSpecificationContribution.create(element);
   }
}
