...
public final class DeleteDeviceHandler extends BaseDeleteElementHandler<Device> {

   @Override
   protected CCommand createCommand(final Device element) {
      return DeleteDeviceContribution.create(element);
   }
}
