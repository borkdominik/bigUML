...
public class CreateExecutionEnvironmentHandler extends BaseCreateChildNodeHandler<Object>
   implements CreateLocationAwareNodeHandler {

   public CreateExecutionEnvironmentHandler() {
   ...
   protected CCommand createCommand(final CreateNodeOperation operation, final Object parent) {
      return CreateExecutionEnvironmentContribution.create(
         parent,
