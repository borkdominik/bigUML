...
public final class DeleteManifestationHandler extends BaseDeleteElementHandler<Manifestation> {

   @Override
   protected CCommand createCommand(final Manifestation element) {
      return DeleteManifestationContribution.create(element);
   }
}
