...
public final class DeleteModelHandler extends BaseDeleteElementHandler<Model> {

   @Override
   protected CCommand createCommand(final Model element) {
      return DeleteModelContribution.create(element);
   }
}
