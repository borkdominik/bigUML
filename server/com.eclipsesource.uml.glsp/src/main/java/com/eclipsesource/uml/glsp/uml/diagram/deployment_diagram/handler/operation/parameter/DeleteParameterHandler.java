...
public final class DeleteParameterHandler extends BaseDeleteElementHandler<Parameter> {

   @Override
   protected CCommand createCommand(final Parameter element) {
      return DeleteParameterContribution.create(element);
   }
}
