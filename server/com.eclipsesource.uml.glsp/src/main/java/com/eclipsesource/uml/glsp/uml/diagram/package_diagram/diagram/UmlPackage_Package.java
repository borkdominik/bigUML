...
public class UmlPackage_Package {

   public static String typeId() {
      return QualifiedUtil.representationTypeId(Representation.PACKAGE, DefaultTypes.NODE,
      ...
      public Set<ShapeTypeHint> getShapeTypeHints() {
         return Set.of(
            new ShapeTypeHint(typeId(), true, true, true, false,
               List.of(UmlPackage_Package.typeId(), UmlPackage_Class.typeId())));
      }
   }
}
