...
public class PackageImportPropertyMapper extends BaseDiagramElementPropertyMapper<PackageImport> {
   ...
   public PropertyPalette map(final PackageImport source) {
      ...
      var items = this.propertyBuilder(UmlPackage_PackageImport.Property.class, elementId)
         .choice(
            UmlPackage_PackageImport.Property.VISIBILITY_KIND,
            "Visibility",
   ...
   public Optional<UpdateOperation> map(final UpdateElementPropertyAction action) {
      var property = getProperty(UmlPackage_PackageImport.Property.class, action);
