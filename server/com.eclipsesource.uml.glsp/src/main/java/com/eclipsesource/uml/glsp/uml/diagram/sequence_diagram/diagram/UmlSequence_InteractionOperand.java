...
public class UmlSequence_InteractionOperand {

   public static String typeId() {
      return QualifiedUtil.representationTypeId(Representation.SEQUENCE, DefaultTypes.COMPARTMENT,
         InteractionOperand.class.getSimpleName());
   }
   ...
   private UmlSequence_InteractionOperand() {}
