      ...
      public Set<ShapeTypeHint> getShapeTypeHints() {
         return Set.of(
            new ShapeTypeHint(typeId(), true, true, true, false,
               List.of(UmlSequence_MessageOccurrence.typeId(),
                  UmlSequence_DestructionOccurrence.typeId(),
                  UmlSequence_ExecutionOccurrence.typeId(),
                  UmlSequence_BehaviorExecution.typeId())));
      }
   }
}
