 ...
 ********************************************************************************/
package com.eclipsesource.uml.glsp.uml.diagram.sequence_diagram.features.label_edit;
...
public final class InteractionOperandLabelEditMapper extends BaseLabelEditMapper<InteractionOperand> {

   @Override
   public Optional<UpdateOperation> map(final ApplyLabelEditOperation operation) {
      var handler = getHandler(UpdateInteractionOperandHandler.class, operation);
