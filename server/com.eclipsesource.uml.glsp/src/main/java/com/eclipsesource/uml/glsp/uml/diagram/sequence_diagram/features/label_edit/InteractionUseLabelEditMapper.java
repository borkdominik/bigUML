...
public final class InteractionUseLabelEditMapper extends BaseLabelEditMapper<InteractionUse> {

   @Override
   public Optional<UpdateOperation> map(final ApplyLabelEditOperation operation) {
      var handler = getHandler(UpdateInteractionUseHandler.class, operation);
