...
public final class UpdateInteractionOperandHandler
   extends BaseUpdateElementHandler<InteractionOperand, UpdateInteractionOperandArgument> {

   public UpdateInteractionOperandHandler() {
      super(UmlSequence_InteractionOperand.typeId());
   }

   @Override
   protected CCommand createCommand(final UpdateOperation operation, final InteractionOperand element,
      final UpdateInteractionOperandArgument updateArgument) {
      return UpdateInteractionOperandContribution.create(element, updateArgument);
   }
}
