...
public class CreateFoundMessageHandler
   extends BaseCreateEdgeHandler<Interaction, Lifeline> implements CreateLocationAwareNodeHandler {

   public CreateFoundMessageHandler() {
      super(UmlSequence_Message.Variant.foundTypeId());
   }
   ...
   protected CCommand createCommand(final CreateEdgeOperation operation, final Interaction source,
      ...
      var keyword_kind = UmlMessageKind.FOUND;
