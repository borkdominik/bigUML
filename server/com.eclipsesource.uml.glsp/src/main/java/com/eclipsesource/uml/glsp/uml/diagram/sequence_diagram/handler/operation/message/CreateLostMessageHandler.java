...
public class CreateLostMessageHandler
   extends BaseCreateEdgeHandler<Lifeline, Interaction> implements CreateLocationAwareNodeHandler {

   public CreateLostMessageHandler() {
      super(UmlSequence_Message.Variant.lostTypeId());
   }
   ...
   @Override
   protected CCommand createCommand(final CreateEdgeOperation operation, final Lifeline source,
      final Interaction target) {
      ...
      var keyword_sort = UmlMessageSort.ASYNC;
      var keyword_kind = UmlMessageKind.LOST;
