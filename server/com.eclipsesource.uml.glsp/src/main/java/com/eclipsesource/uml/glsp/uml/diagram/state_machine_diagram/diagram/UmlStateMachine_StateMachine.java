...
public class UmlStateMachine_StateMachine {
   ...
   public static class DiagramConfiguration implements DiagramElementConfiguration.Node {
      ...
      @Override
      public Set<String> getGraphContainableElements() { return Set.of(typeId(), UmlStateMachine_Region.typeId()); }

      @Override
      public Set<ShapeTypeHint> getShapeTypeHints() {
         return Set.of(
            new ShapeTypeHint(typeId(), true, true, true, false,
               List.of(UmlStateMachine_Region.typeId())));
      }
   }
}
