 ...
 ********************************************************************************/
package com.eclipsesource.uml.glsp.uml.diagram.state_machine_diagram.features.label_edit;
...
public class TransitionLabelEditMapper extends BaseLabelEditMapper<Transition> {
   @Override
   public Optional<UpdateOperation> map(final ApplyLabelEditOperation operation) {
      var handler = getHandler(UpdateTransitionHandler.class, operation);
