...
public class TransitionEdgeMapper extends BaseGEdgeMapper<Transition, GEdge> implements EdgeGBuilder {

   @Override
   public GEdge map(final Transition transition) {
      var builder = new GEdgeBuilder(UmlStateMachine_Transition.typeId())
