 ...
 ********************************************************************************/
package com.eclipsesource.uml.glsp.uml.diagram.state_machine_diagram.handler.operation.choice;
...
public class CreateChoiceHandler extends BaseCreateChildNodeHandler<Region>
   implements CreateLocationAwareNodeHandler {

   public CreateChoiceHandler() {
      super(UmlStateMachine_Choice.typeId());
   }
   ...
   protected CCommand createCommand(final CreateNodeOperation operation, final Region parent) {
      return CreatePseudoStateContribution.create(
         parent,
         relativeLocationOf(modelState, operation).orElse(GraphUtil.point(0, 0)), PseudostateKind.CHOICE_LITERAL);
   }
}
