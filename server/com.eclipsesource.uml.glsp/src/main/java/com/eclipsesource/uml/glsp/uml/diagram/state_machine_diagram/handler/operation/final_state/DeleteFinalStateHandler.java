...
public class DeleteFinalStateHandler extends BaseDeleteElementHandler<FinalState> {

   @Override
   protected CCommand createCommand(final FinalState element) {
      return DeleteFinalStateContribution.create(element);
   }
}
