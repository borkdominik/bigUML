 ...
 ********************************************************************************/
package com.eclipsesource.uml.glsp.uml.diagram.state_machine_diagram.handler.operation.initial_state;
...
public class CreateInitialStateHandler extends BaseCreateChildNodeHandler<Region>
   implements CreateLocationAwareNodeHandler {

   public CreateInitialStateHandler() {
      super(UmlStateMachine_InitialState.typeId());
   }
   ...
   protected CCommand createCommand(final CreateNodeOperation operation, final Region parent) {
      return CreatePseudoStateContribution.create(
         parent,
         relativeLocationOf(modelState, operation).orElse(GraphUtil.point(0, 0)), PseudostateKind.INITIAL_LITERAL);
   }
}
