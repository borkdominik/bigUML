 ...
 ********************************************************************************/
package com.eclipsesource.uml.glsp.uml.diagram.state_machine_diagram.handler.operation.join;
...
public class CreateJoinHandler extends BaseCreateChildNodeHandler<Region>
   implements CreateLocationAwareNodeHandler {

   public CreateJoinHandler() {
      super(UmlStateMachine_Join.typeId());
   }
   ...
   protected CCommand createCommand(final CreateNodeOperation operation, final Region parent) {
      return CreatePseudoStateContribution.create(
         parent,
         relativeLocationOf(modelState, operation).orElse(GraphUtil.point(0, 0)), PseudostateKind.JOIN_LITERAL);
   }
}
