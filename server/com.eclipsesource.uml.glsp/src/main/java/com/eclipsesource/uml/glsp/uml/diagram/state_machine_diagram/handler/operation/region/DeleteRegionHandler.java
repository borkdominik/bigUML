...
public class DeleteRegionHandler extends BaseDeleteElementHandler<Region> {

   @Override
   protected CCommand createCommand(final Region element) {
      return DeleteRegionContribution.create(element);
   }
}
