 ...
 ********************************************************************************/
package com.eclipsesource.uml.glsp.uml.diagram.state_machine_diagram.handler.operation.shallow_history;
...
public class CreateShallowHistoryHandler extends BaseCreateChildNodeHandler<Region>
   implements CreateLocationAwareNodeHandler {

   public CreateShallowHistoryHandler() {
      super(UmlStateMachine_ShallowHistory.typeId());
   }
