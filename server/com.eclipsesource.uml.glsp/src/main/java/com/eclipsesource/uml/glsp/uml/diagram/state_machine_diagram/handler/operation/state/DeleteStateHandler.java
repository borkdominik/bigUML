...
public class DeleteStateHandler extends BaseDeleteElementHandler<State> {

   @Override
   protected CCommand createCommand(final State element) {
      return DeleteStateContribution.create(element);
   }
}
