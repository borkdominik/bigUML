...
public class DeleteTransitionHandler extends BaseDeleteElementHandler<Transition> {

   @Override
   protected CCommand createCommand(final Transition element) {
      return DeleteTransitionContribution.create(element);
   }
}
