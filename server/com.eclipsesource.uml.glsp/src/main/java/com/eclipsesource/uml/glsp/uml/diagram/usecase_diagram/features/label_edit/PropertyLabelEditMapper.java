      ...
      if (matches(operation, CoreTypes.LABEL_NAME, NameLabelSuffix.SUFFIX)) {
         update = handler.withArgument(
            new UpdatePropertyArgument.Builder()
               ...
               .get());
      } else if (matches(operation, UmlUseCase_Property.Label.multiplicityTypeId(),
         ...
         update = handler.withArgument(
            new UpdatePropertyArgument.Builder()
               ...
               .get());
      } else if (matches(operation, UmlUseCase_Property.Label.typeTypeId(), PropertyTypeLabelSuffix.SUFFIX)) {
         update = handler.withArgument(
            new UpdatePropertyArgument.Builder()
