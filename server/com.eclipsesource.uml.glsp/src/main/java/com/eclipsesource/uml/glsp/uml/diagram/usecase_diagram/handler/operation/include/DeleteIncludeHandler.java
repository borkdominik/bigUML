...
public class DeleteIncludeHandler extends BaseDeleteElementHandler<Include> {

   @Override
   protected CCommand createCommand(final Include element) {
      return DeleteIncludeContribution.create(element);
   }
