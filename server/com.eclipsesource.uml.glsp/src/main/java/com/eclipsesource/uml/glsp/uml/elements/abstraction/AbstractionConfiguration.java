...
public class AbstractionConfiguration extends RepresentationEdgeConfiguration<Abstraction> {
   @Inject
   public AbstractionConfiguration(@Assisted final Representation representation) {
