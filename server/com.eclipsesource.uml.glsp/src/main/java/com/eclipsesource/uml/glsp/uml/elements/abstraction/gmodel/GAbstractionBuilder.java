...
public class GAbstractionBuilder<TSource extends Class, TProvider extends GSuffixProvider & GIdGeneratorProvider & GIdContextGeneratorProvider & GModelMapHandlerProvider, TBuilder extends GAbstractionBuilder<TSource, TProvider, TBuilder>>
   extends GClassifierBuilder<TSource, TProvider, TBuilder> {

   public GAbstractionBuilder(final TSource source, final TProvider provider, final String type) {
