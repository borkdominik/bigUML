...
public class ActivityConfiguration extends RepresentationNodeConfiguration<Activity> {

   @Inject
   public ActivityConfiguration(@Assisted final Representation representation) {
