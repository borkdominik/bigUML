...
public final class ActivityNodeLabelEditMapper extends RepresentationLabelEditMapper<ActivityNode> {

   @Inject
   public ActivityNodeLabelEditMapper(@Assisted final Representation representation) {
      super(representation);
   }

   @Override
   public Optional<UpdateOperation> map(final ApplyLabelEditOperation operation) {
      var handler = getHandler(ActivityNodeOperationHandler.class, operation);
