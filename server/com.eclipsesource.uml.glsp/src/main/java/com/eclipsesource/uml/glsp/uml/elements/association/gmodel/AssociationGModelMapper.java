...
public class AssociationGModelMapper extends RepresentationGEdgeMapper<Association, GEdge> {

   @Inject
   public AssociationGModelMapper(@Assisted final Representation representation) {
