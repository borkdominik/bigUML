...
public final class CommunicationPathLabelEditMapper extends RepresentationLabelEditMapper<CommunicationPath> {

   @Inject
   public CommunicationPathLabelEditMapper(@Assisted final Representation representation) {
      super(representation);
   }

   @Override
   public Optional<UpdateOperation> map(final ApplyLabelEditOperation operation) {
      var handler = getHandler(CommunicationPathOperationHandler.class, operation);
