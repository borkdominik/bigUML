...
public class DataTypeConfiguration extends RepresentationNodeConfiguration<DataType> {

   @Inject
   public DataTypeConfiguration(@Assisted final Representation representation) {
