...
public class DeploymentSpecificationConfiguration extends RepresentationNodeConfiguration<DeploymentSpecification> {

   @Inject
   public DeploymentSpecificationConfiguration(@Assisted final Representation representation) {
