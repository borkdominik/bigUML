...
public class DeviceConfiguration extends RepresentationNodeConfiguration<Device> {

   @Inject
   public DeviceConfiguration(@Assisted final Representation representation) {
