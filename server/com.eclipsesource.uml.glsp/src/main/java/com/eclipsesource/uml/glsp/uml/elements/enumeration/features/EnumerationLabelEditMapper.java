...
public final class EnumerationLabelEditMapper extends RepresentationLabelEditMapper<Enumeration> {

   @Inject
   public EnumerationLabelEditMapper(@Assisted final Representation representation) {
      super(representation);
   }

   @Override
   public Optional<UpdateOperation> map(final ApplyLabelEditOperation operation) {
      var handler = getHandler(EnumerationOperationHandler.class, operation);
