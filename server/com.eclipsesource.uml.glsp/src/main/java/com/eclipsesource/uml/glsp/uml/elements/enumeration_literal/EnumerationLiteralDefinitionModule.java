...
public class EnumerationLiteralDefinitionModule extends NodeFactoryDefinition {

   public EnumerationLiteralDefinitionModule(final DiagramManifest manifest) {
      super(manifest.id(), manifest.representation(), EnumerationLiteralFactory.class);
   }
}
