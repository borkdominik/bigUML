...
import com.eclipsesource.uml.glsp.uml.elements.enumeration_literal.gmodel.EnumerationLiteralNodeMapper;
...
public interface EnumerationLiteralFactory
   ...
   @Override
   EnumerationLiteralNodeMapper gmodel(Representation representation);
