...
public class ExecutionEnvironmentDefinitionModule extends NodeFactoryDefinition {

   public ExecutionEnvironmentDefinitionModule(final DiagramManifest manifest) {
      super(manifest.id(), manifest.representation(), ExecutionEnvironmentFactory.class);
   }
}
