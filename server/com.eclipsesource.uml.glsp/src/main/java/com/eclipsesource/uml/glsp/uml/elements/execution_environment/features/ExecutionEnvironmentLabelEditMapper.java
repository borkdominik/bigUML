...
public final class ExecutionEnvironmentLabelEditMapper extends RepresentationLabelEditMapper<ExecutionEnvironment> {

   @Inject
   public ExecutionEnvironmentLabelEditMapper(@Assisted final Representation representation) {
      super(representation);
   }

   @Override
   public Optional<UpdateOperation> map(final ApplyLabelEditOperation operation) {
      var handler = getHandler(ExecutionEnvironmentOperationHandler.class, operation);
