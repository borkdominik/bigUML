 ...
 ********************************************************************************/
package com.eclipsesource.uml.glsp.uml.elements.execution_environment.gmodel;
...
public class ExecutionEnvironmentNodeMapper extends RepresentationGNodeMapper<ExecutionEnvironment, GNode>
   implements NamedElementGBuilder<ExecutionEnvironment> {

   @Inject
   public ExecutionEnvironmentNodeMapper(@Assisted final Representation representation) {
