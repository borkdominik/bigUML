...
public class ExtendConfiguration extends RepresentationEdgeConfiguration<Extend> {
   @Inject
   public ExtendConfiguration(@Assisted final Representation representation) {
