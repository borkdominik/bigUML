...
public class FinalStateConfiguration extends RepresentationNodeConfiguration<FinalState> {

   @Inject
   public FinalStateConfiguration(@Assisted final Representation representation) {
