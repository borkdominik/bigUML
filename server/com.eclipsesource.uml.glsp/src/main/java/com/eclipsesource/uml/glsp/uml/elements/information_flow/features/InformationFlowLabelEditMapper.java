...
public final class InformationFlowLabelEditMapper extends RepresentationLabelEditMapper<InformationFlow> {

   @Inject
   public InformationFlowLabelEditMapper(@Assisted final Representation representation) {
      super(representation);
   }

   @Override
   public Optional<UpdateOperation> map(final ApplyLabelEditOperation operation) {
      var handler = getHandler(InformationFlowOperationHandler.class, operation);
