...
public class InterfaceConfiguration extends RepresentationNodeConfiguration<Interface> {

   @Inject
   public InterfaceConfiguration(@Assisted final Representation representation) {
