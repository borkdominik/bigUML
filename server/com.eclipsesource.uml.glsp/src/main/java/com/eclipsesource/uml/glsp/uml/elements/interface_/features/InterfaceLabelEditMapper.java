...
public final class InterfaceLabelEditMapper extends RepresentationLabelEditMapper<Interface> {

   @Inject
   public InterfaceLabelEditMapper(@Assisted final Representation representation) {
