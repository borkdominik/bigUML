...
public class LifelineConfiguration extends RepresentationNodeConfiguration<Lifeline> {

   @Inject
   public LifelineConfiguration(@Assisted final Representation representation) {
