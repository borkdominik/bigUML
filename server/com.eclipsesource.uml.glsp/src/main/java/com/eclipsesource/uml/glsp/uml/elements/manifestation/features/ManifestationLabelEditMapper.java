...
public final class ManifestationLabelEditMapper extends RepresentationLabelEditMapper<Manifestation> {

   @Inject
   public ManifestationLabelEditMapper(@Assisted final Representation representation) {
      super(representation);
   }

   @Override
   public Optional<UpdateOperation> map(final ApplyLabelEditOperation operation) {
      var handler = getHandler(ManifestationOperationHandler.class, operation);
