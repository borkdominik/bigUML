 ...
 ********************************************************************************/
package com.eclipsesource.uml.glsp.uml.elements.model.gmodel;
...
public class ModelNodeMapper extends RepresentationGNodeMapper<Model, GNode>
   implements NamedElementGBuilder<Model> {

   @Inject
   public ModelNodeMapper(@Assisted final Representation representation) {
