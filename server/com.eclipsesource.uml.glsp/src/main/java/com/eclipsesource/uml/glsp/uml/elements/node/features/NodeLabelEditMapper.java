...
public final class NodeLabelEditMapper extends RepresentationLabelEditMapper<Node> {

   @Inject
   public NodeLabelEditMapper(@Assisted final Representation representation) {
      super(representation);
   }

   @Override
   public Optional<UpdateOperation> map(final ApplyLabelEditOperation operation) {
      var handler = getHandler(NodeOperationHandler.class, operation);
