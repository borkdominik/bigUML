 ...
 ********************************************************************************/
package com.eclipsesource.uml.glsp.uml.elements.node.gmodel;
...
public class NodeNodeMapper extends RepresentationGNodeMapper<Node, GNode>
   implements NamedElementGBuilder<Node> {

   @Inject
   public NodeNodeMapper(@Assisted final Representation representation) {
