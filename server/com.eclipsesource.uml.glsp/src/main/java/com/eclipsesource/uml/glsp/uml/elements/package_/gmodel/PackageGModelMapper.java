...
public final class PackageGModelMapper extends RepresentationGNodeMapper<Package, GNode> {

   @Inject
   public PackageGModelMapper(@Assisted final Representation representation) {
      super(representation);
   }

   @Override
   public GNode map(final Package source) {
      return new GPackageBuilder<>(gmodelContext, source, configuration().typeId()).buildGModel();
   }
