...
public class PackageMergeConfiguration extends RepresentationEdgeConfiguration<PackageMerge> {
   @Inject
   public PackageMergeConfiguration(@Assisted final Representation representation) {
