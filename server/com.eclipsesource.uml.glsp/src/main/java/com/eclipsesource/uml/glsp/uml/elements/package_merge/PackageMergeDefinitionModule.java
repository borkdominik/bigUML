...
public class PackageMergeDefinitionModule extends EdgeOperationHandlerDefinition {
   ...
   protected void diagramConfigurations(final Multibinder<Edge> contribution) {
      contribution.addBinding().to(PackageMergeConfiguration.Diagram.class);
   }

   @Override
   protected Optional<TypeLiteral<? extends EdgeOperationHandler<?, ?, ?>>> operationHandler() {
      return Optional.of(new TypeLiteral<PackageMergeOperationHandler>() {});
   }
