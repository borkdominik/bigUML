...
public class InputPinConfiguration extends RepresentationNodeConfiguration<InputPin> {

   @Inject
   public InputPinConfiguration(@Assisted final Representation representation) {
      super(representation);
   }

   @Override
   public String typeId() {
      return QualifiedUtil.representationTypeId(representation, DefaultTypes.PORT, InputPin.class.getSimpleName());
   }
