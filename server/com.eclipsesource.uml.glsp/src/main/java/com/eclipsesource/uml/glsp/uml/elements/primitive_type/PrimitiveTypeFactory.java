...
import com.eclipsesource.uml.glsp.uml.elements.primitive_type.gmodel.PrimitiveTypeGModelMapper;
...
public interface PrimitiveTypeFactory
   ...
   @Override
   PrimitiveTypeGModelMapper gmodel(Representation representation);
