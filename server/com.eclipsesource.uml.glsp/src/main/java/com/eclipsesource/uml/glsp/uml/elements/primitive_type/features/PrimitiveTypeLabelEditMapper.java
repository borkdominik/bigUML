...
public final class PrimitiveTypeLabelEditMapper extends RepresentationLabelEditMapper<PrimitiveType> {

   @Inject
   public PrimitiveTypeLabelEditMapper(@Assisted final Representation representation) {
      super(representation);
   }

   @Override
   public Optional<UpdateOperation> map(final ApplyLabelEditOperation operation) {
      var handler = getHandler(PrimitiveTypeOperationHandler.class, operation);
