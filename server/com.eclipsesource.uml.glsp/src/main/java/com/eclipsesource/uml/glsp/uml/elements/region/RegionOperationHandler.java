...
public class RegionOperationHandler extends NodeOperationHandler<Region, StateMachine> {

   @Inject
   public RegionOperationHandler(@Assisted final Representation representation,
