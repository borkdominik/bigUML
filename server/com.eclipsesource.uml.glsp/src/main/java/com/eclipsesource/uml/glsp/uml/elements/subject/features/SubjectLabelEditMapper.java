...
public class SubjectLabelEditMapper extends RepresentationLabelEditMapper<Component> {

   @Inject
   public SubjectLabelEditMapper(@Assisted final Representation representation) {
      super(representation);
   }

   @Override
   public Optional<UpdateOperation> map(final ApplyLabelEditOperation operation) {
      var handler = getHandler(SubjectOperationHandler.class, operation);
