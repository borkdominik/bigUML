...
public class SubjectPropertyMapper extends RepresentationElementPropertyMapper<Component> {

   @Inject
   public SubjectPropertyMapper(@Assisted final Representation representation) {
