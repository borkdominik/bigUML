...
public class SubstitutionConfiguration extends RepresentationEdgeConfiguration<Substitution> {
   @Inject
   public SubstitutionConfiguration(@Assisted final Representation representation) {
