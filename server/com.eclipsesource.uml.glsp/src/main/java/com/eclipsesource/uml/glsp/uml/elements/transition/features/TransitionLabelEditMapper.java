...
public class TransitionLabelEditMapper
   extends RepresentationLabelEditMapper<Transition> {

   @Inject
   public TransitionLabelEditMapper(@Assisted final Representation representation) {
      super(representation);
   }

   @Override
   public Optional<UpdateOperation> map(final ApplyLabelEditOperation operation) {
      var handler = getHandler(TransitionOperationHandler.class, operation);
