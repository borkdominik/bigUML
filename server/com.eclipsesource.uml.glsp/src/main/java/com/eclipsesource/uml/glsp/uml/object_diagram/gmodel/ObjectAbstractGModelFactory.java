...
public abstract class ObjectAbstractGModelFactory<T extends EObject, E extends GModelElement> {

   protected UmlModelState modelState;

   public ObjectAbstractGModelFactory(final UmlModelState modelState) {
