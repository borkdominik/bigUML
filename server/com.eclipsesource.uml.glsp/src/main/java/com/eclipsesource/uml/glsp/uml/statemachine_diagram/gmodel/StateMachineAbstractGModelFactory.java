...
public abstract class StateMachineAbstractGModelFactory<T extends EObject, E extends GModelElement> {

   protected UmlModelState modelState;

   public StateMachineAbstractGModelFactory(final UmlModelState modelState) {
