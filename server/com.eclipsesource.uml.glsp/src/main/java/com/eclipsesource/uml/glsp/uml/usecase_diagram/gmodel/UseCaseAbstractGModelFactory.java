...
public abstract class UseCaseAbstractGModelFactory<T extends EObject, E extends GModelElement> {

   protected UmlModelState modelState;

   public UseCaseAbstractGModelFactory(final UmlModelState modelState) {
