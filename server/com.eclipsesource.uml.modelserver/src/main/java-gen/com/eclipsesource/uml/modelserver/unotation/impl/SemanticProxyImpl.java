 ...
 * </p>
 * <ul>
 *   <li>{@link com.eclipsesource.uml.modelserver.unotation.impl.SemanticProxyImpl#getUri <em>Uri</em>}</li>
 *   <li>{@link com.eclipsesource.uml.modelserver.unotation.impl.SemanticProxyImpl#getResolvedElement <em>Resolved Element</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SemanticProxyImpl extends MinimalEObjectImpl.Container implements SemanticProxy {
   ...
   protected EClass eStaticClass() {
      return UnotationPackage.Literals.SEMANTIC_PROXY;
   }
   ...
   public void setUri(String newUri) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, UnotationPackage.SEMANTIC_PROXY__URI, oldUri, uri));
   }
   ...
   public EObject getResolvedElement() {
      if (resolvedElement != null && resolvedElement.eIsProxy()) {
         ...
         if (resolvedElement != oldResolvedElement) {
            if (eNotificationRequired())
               eNotify(new ENotificationImpl(this, Notification.RESOLVE, UnotationPackage.SEMANTIC_PROXY__RESOLVED_ELEMENT, oldResolvedElement, resolvedElement));
         }
      }
   ...
   public void setResolvedElement(EObject newResolvedElement) {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, UnotationPackage.SEMANTIC_PROXY__RESOLVED_ELEMENT, oldResolvedElement, resolvedElement));
   }
   ...
   public Object eGet(int featureID, boolean resolve, boolean coreType) {
      switch (featureID) {
         case UnotationPackage.SEMANTIC_PROXY__URI:
            return getUri();
         case UnotationPackage.SEMANTIC_PROXY__RESOLVED_ELEMENT:
