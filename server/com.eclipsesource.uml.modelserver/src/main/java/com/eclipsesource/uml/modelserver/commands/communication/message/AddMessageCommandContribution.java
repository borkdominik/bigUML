...
public class AddMessageCommandContribution extends UmlCompoundCommandContribution {
   ...
   public static CCompoundCommand create(final String sourceClassUriFragment, final String targetClassUriFragment) {
      ...
      addMessageCommand.getProperties().put(SOURCE_LIFELINE_URI_FRAGMENT, sourceClassUriFragment);
      addMessageCommand.getProperties().put(TARGET_LIFELINE_URI_FRAGMENT, targetClassUriFragment);
