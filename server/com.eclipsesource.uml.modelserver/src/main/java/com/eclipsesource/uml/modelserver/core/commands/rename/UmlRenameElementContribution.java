 ...
 ********************************************************************************/
package com.eclipsesource.uml.modelserver.core.commands.rename;
...
public final class UmlRenameElementContribution extends BasicCommandContribution<Command> {
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      return element
         .<Command> map(e -> new UmlRenameElementSemanticCommand(context, e, newName))
