...
public class SetLifelineNameContribution extends BasicCommandContribution<Command> {
   ...
   public static CCommand create(final Lifeline lifeline, final String newName) {
      ...
      setLifelineNameCommand.getProperties().put(SemanticKeys.SEMANTIC_URI_FRAGMENT,
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      return new SetLifelineNameSemanticCommand(domain, modelUri, semanticUriFragment, newName);
   }
