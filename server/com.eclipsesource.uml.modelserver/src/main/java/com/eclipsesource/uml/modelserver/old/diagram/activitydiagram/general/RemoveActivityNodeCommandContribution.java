 ...
 ********************************************************************************/
package com.eclipsesource.uml.modelserver.old.diagram.activitydiagram.general;

public class RemoveActivityNodeCommandContribution { /*-

   public static final String TYPE = "removeActivityNode";
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      return new RemoveActivityNodeCompoundCommand(domain, modelUri, parentSemanticUri, semanticUri);
   }
   */
}
