 ...
 ********************************************************************************/
package com.eclipsesource.uml.modelserver.old.diagram.classdiagram.util;
...
public class ClassSemanticCommandUtil {
   ...
   public static String getNewClassName(final Model umlModel) {
      return getNewPackageableElementName(org.eclipse.uml2.uml.Class.class, umlModel);
   }
   ...
   public static String getNewEnumerationName(final Model umlModel) {
      return getNewPackageableElementName(Enumeration.class, umlModel);
   }
