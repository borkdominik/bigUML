...
public abstract class BaseNotationExistenceCheckedCommand<TSemantic extends EObject, TNotation extends NotationElement>
   ...
   public BaseNotationExistenceCheckedCommand(final ModelContext context,
      final TSemantic semanticElement) {
      super(context);
      notationElementClass = GenericsUtil.getClassParameter(getClass(), BaseNotationExistenceCheckedCommand.class, 1);
