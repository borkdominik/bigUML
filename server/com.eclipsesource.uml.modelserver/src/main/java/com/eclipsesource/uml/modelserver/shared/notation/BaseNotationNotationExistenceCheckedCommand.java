...
public abstract class BaseNotationNotationExistenceCheckedCommand<TSemantic extends EObject, TNotation extends NotationElement>
   ...
   public BaseNotationNotationExistenceCheckedCommand(final ModelContext context,
      final TSemantic semanticElement) {
      super(context);
      notationElementClass = GenericsUtil.getClassParameter(
         getClass(),
         BaseNotationNotationExistenceCheckedCommand.class, 1);
