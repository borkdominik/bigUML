...
public abstract class BaseCreateSemanticChildRelationCommand<TParent, TChild, TSource, TTarget>
   ...
   public BaseCreateSemanticChildRelationCommand(final ModelContext context, final TParent parent, final TSource source,
