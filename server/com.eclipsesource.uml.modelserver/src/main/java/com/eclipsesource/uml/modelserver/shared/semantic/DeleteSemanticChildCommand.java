...
public abstract class DeleteSemanticChildCommand<TParent, TChild extends EObject>
   extends UmlSemanticElementCommand {

   protected TParent parent;
   protected TChild child;

   public DeleteSemanticChildCommand(final ModelContext context, final TParent parent, final TChild child) {
      super(context);
      this.parent = parent;
      this.child = child;
   }
