...
public abstract class EdgeCommandProvider<TElement extends EObject, TSource extends EObject, TTarget extends EObject>
   extends ElementCommandProvider<TElement> implements CreateEdgeCommandProvider<TElement> {
   ...
   @Override
   public Command provideCreateEdgeCommand(final ModelContext context) {
