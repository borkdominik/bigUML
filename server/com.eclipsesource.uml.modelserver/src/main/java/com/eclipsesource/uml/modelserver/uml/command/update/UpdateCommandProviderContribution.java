...
public interface UpdateCommandProviderContribution
   extends ContributionBinderSupplier, ContributionIdSupplier, ContributionRepresentationSupplier {

   default void contributeUpdateCommandProvider(
      ...
      MapBinder.newMapBinder(binder, new TypeLiteral<Representation>() {},
         new TypeLiteral<Set<UpdateCommandProvider<? extends EObject>>>() {})
         .addBinding(representation())
         .to(Key.get(new TypeLiteral<Set<UpdateCommandProvider<? extends EObject>>>() {}, idNamed()));
   }
