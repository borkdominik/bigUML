...
public final class CreateAbstractionCompoundCommand extends CompoundCommand {

   public CreateAbstractionCompoundCommand(final ModelContext context,
      final NamedElement source,
      final NamedElement target) {

      var command = new CreateAbstractionSemanticCommand(context, source,
         target);
      this.append(command);
