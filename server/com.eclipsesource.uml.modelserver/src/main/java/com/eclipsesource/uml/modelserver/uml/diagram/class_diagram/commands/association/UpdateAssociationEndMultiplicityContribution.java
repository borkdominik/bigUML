...
public final class UpdateAssociationEndMultiplicityContribution extends BasicCommandContribution<Command> {
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      return element
         .<Command> map(e -> new UpdateAssociationEndMultiplicitySemanticCommand(context, e, newLowerBound,
            newUpperBound))
