...
public final class CreateDataTypeContribution extends BasicCommandContribution<Command> {

   public static final String TYPE = "class:add_data_type";
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      return parent
         .<Command> map(p -> new CreateDataTypeCompoundCommand(context, p, position))
