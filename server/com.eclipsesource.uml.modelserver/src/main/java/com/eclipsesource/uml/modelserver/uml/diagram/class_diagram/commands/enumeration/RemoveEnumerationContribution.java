...
public class RemoveEnumerationContribution extends BasicCommandContribution<Command> {
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      var semanticElement = elementAccessor.getElement(semanticElementId, Enumeration.class);
      ...
      if (parent.isPresent() && semanticElement.isPresent()) {
         return new RemoveEnumerationCompoundCommand(context, parent.get(), semanticElement.get());
      }
