...
public final class RemoveOperationContribution extends BasicCommandContribution<Command> {
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      var parent = decoder.parent(OperationOwner.class);
      var element = decoder.element(Operation.class);

      if (parent.isPresent() && element.isPresent()) {
         return new RemoveOperationSemanticCommand(context, parent.get(), element.get());
      }
