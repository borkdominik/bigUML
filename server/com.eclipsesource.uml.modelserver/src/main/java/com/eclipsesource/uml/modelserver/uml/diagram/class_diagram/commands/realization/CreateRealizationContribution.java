...
public final class CreateRealizationContribution extends BasicCommandContribution<Command> {

   public static final String TYPE = "class:add_realization";
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      if (source.isPresent() && target.isPresent()) {
         return new CreateRealizationCompoundCommand(context, source.get(), target.get());
      }
