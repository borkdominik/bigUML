...
public final class CreateSubstitutionContribution extends BasicCommandContribution<Command> {

   public static final String TYPE = "class:add_substitution";
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      if (source.isPresent() && target.isPresent()) {
         return new CreateSubstitutionCompoundCommand(context, source.get(), target.get());
      }
