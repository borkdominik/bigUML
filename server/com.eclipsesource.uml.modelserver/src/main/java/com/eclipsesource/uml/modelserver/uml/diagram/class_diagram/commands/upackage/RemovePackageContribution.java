...
public final class RemovePackageContribution extends BasicCommandContribution<Command> {
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      if (parent.isPresent() && element.isPresent()) {
         return new RemovePackageCompoundCommand(context, parent.get(), element.get());
      }
