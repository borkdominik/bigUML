...
public final class CreateUsageCompoundCommand extends CompoundCommand {

   public CreateUsageCompoundCommand(final ModelContext context,
      final NamedElement source,
      final NamedElement target) {

      var command = new CreateUsageSemanticCommand(context, source,
         target);
      this.append(command);
