...
public final class EnumerationLiteralReferenceRemover extends BaseCrossReferenceProcessor<EnumerationLiteral> {

   @Override
   protected List<Command> process(final ModelContext context, final Setting setting, final EnumerationLiteral self,
      final EObject interest) {
      return List.of(new DeleteEnumerationLiteralSemanticCommand(context, self));
   }
}
