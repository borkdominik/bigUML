...
public final class EnumerationReferenceRemover extends BaseCrossReferenceProcessor<Enumeration> {

   @Override
   protected List<Command> process(final ModelContext context, final Setting setting, final Enumeration self,
      final EObject interest) {
      if (self.getPackage().equals(interest)) {
         return List.of(new DeleteEnumerationCompoundCommand(context, self));
      }
