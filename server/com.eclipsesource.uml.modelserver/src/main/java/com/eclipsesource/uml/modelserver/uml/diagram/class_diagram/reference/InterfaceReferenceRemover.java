...
public final class InterfaceReferenceRemover extends BaseCrossReferenceProcessor<Interface> {

   @Override
   protected List<Command> process(final ModelContext context, final Setting setting, final Interface self,
      final EObject interest) {
      if (self.getPackage().equals(interest)) {
         return List.of(new DeleteInterfaceCompoundCommand(context, self));
      }
