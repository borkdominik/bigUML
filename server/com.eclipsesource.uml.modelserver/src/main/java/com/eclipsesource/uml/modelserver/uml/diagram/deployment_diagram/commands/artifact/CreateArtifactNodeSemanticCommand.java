...
public class CreateArtifactNodeSemanticCommand
   extends BaseCreateSemanticChildCommand<Node, Artifact> {

   public CreateArtifactNodeSemanticCommand(final ModelContext context,
      final Node parent) {
      super(context, parent);
   }

   @Override
   protected Artifact createSemanticElement(final Node parent) {
