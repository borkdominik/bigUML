...
public class CreateArtifactPackageSemanticCommand
   extends BaseCreateSemanticChildCommand<Package, Artifact> {

   public CreateArtifactPackageSemanticCommand(final ModelContext context,
      final Package parent) {
      super(context, parent);
   }

   @Override
   protected Artifact createSemanticElement(final Package parent) {
