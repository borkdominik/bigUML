...
public final class DeleteArtifactCompoundCommand extends CompoundCommand {

   public DeleteArtifactCompoundCommand(final ModelContext context, final Artifact semanticElement) {
      this.append(new DeleteArtifactSemanticCommand(context, semanticElement));
