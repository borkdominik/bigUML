...
public final class CreateCommunicationPathCompoundCommand extends CompoundCommand {

   public CreateCommunicationPathCompoundCommand(final ModelContext context,
      final Node source, final Node target,
      final AssociationType type) {

      var command = new CreateCommunicationPathSemanticCommand(context, source, target, type);
      this.append(command);
