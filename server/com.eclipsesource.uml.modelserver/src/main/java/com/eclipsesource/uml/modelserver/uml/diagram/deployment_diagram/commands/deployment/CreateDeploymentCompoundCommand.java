...
public final class CreateDeploymentCompoundCommand extends CompoundCommand {

   public CreateDeploymentCompoundCommand(final ModelContext context,
      final NamedElement source, final NamedElement target) {

      var command = new CreateDeploymentSemanticCommand(context, source, target);
      this.append(command);
