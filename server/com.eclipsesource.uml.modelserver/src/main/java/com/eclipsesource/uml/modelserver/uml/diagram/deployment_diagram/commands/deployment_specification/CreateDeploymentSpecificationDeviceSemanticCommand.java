...
public class CreateDeploymentSpecificationDeviceSemanticCommand
   extends BaseCreateSemanticChildCommand<Device, DeploymentSpecification> {

   public CreateDeploymentSpecificationDeviceSemanticCommand(final ModelContext context, final Device parent) {
      super(context, parent);
   }

   @Override
   protected DeploymentSpecification createSemanticElement(final Device parent) {
