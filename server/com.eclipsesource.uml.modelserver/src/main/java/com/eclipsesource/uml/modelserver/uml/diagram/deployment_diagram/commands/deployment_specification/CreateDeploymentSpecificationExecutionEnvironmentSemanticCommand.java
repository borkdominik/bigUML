...
public class CreateDeploymentSpecificationExecutionEnvironmentSemanticCommand
   extends BaseCreateSemanticChildCommand<ExecutionEnvironment, DeploymentSpecification> {

   public CreateDeploymentSpecificationExecutionEnvironmentSemanticCommand(final ModelContext context,
      final ExecutionEnvironment parent) {
      super(context, parent);
   }

   @Override
   protected DeploymentSpecification createSemanticElement(final ExecutionEnvironment parent) {
