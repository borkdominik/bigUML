...
public class CreateDeploymentSpecificationNodeSemanticCommand
   extends BaseCreateSemanticChildCommand<Node, DeploymentSpecification> {

   public CreateDeploymentSpecificationNodeSemanticCommand(final ModelContext context, final Node parent) {
      super(context, parent);
   }

   @Override
   protected DeploymentSpecification createSemanticElement(final Node parent) {
