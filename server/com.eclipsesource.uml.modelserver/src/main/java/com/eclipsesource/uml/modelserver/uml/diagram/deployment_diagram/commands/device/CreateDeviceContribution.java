...
public final class CreateDeviceContribution extends BasicCommandContribution<Command> {

   public static final String TYPE = "deployment:add_device";
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      try {
         ...
         return parent
            .<Command> map(p -> new CreateDeviceCompoundCommand(context, p, position))
