...
public class CreateDevicePackageSemanticCommand
   extends BaseCreateSemanticChildCommand<Package, Device> {

   public CreateDevicePackageSemanticCommand(final ModelContext context, final Package parent) {
      super(context, parent);
   }

   @Override
   protected Device createSemanticElement(final Package parent) {
