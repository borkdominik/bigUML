...
public final class CreateExecutionEnvironmentContribution extends BasicCommandContribution<Command> {

   public static final String TYPE = "deployment:add_execution_environment";
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      try {
         ...
         return parent
            .<Command> map(p -> new CreateExecutionEnvironmentCompoundCommand(context, p, position))
