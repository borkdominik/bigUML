...
public class CreateExecutionEnvironmentExecutionEnvironmentPackageSemanticCommand
   extends BaseCreateSemanticChildCommand<ExecutionEnvironment, ExecutionEnvironment> {

   public CreateExecutionEnvironmentExecutionEnvironmentPackageSemanticCommand(final ModelContext context,
      final ExecutionEnvironment parent) {
      super(context, parent);
   }

   @Override
   protected ExecutionEnvironment createSemanticElement(final ExecutionEnvironment parent) {
