...
public class CreateExecutionEnvironmentNodeSemanticCommand
   extends BaseCreateSemanticChildCommand<Node, ExecutionEnvironment> {

   public CreateExecutionEnvironmentNodeSemanticCommand(final ModelContext context,
      final Node parent) {
      super(context, parent);
   }

   @Override
   protected ExecutionEnvironment createSemanticElement(final Node parent) {
