...
public final class CreateGeneralizationContribution extends BasicCommandContribution<Command> {

   public static final String TYPE = "deployment:add_generalization";
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      if (source.isPresent() && target.isPresent()) {
         return new CreateGeneralizationCompoundCommand(context, source.get(), target.get());
      }
