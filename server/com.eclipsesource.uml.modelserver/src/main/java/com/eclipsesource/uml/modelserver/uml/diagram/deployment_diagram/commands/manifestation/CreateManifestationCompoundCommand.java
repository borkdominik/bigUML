...
public final class CreateManifestationCompoundCommand extends CompoundCommand {

   public CreateManifestationCompoundCommand(final ModelContext context,
      final NamedElement source, final NamedElement target) {

      var command = new CreateManifestationSemanticCommand(context, source, target);
      this.append(command);
