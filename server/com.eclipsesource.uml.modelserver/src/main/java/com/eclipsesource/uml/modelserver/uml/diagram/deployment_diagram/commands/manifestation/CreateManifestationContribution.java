...
public final class CreateManifestationContribution extends BasicCommandContribution<Command> {

   public static final String TYPE = "deployment:add_manifestation";
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      if (source.isPresent() && target.isPresent()) {
         return new CreateManifestationCompoundCommand(context, source.get(), target.get());
      }
