...
public final class CreateModelContribution extends BasicCommandContribution<Command> {

   public static final String TYPE = "deployment:add_model";
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      try {
         ...
         return parent
            .<Command> map(p -> new CreateModelCompoundCommand(context, p, position))
