...
public class CreateModelSemanticCommand extends BaseCreateSemanticChildCommand<Model, Model> {

   public CreateModelSemanticCommand(final ModelContext context, final Model parent) {
      super(context, parent);
   }

   @Override
   protected Model createSemanticElement(final Model parent) {
