...
public final class DeleteModelSemanticCommand extends BaseDeleteSemanticChildCommand<Package, Model> {

   public DeleteModelSemanticCommand(final ModelContext context, final Model semanticElement) {
      super(context, semanticElement.getNestingPackage(), semanticElement);
   }

   @Override
   protected void deleteSemanticElement(final Package parent, final Model child) {
