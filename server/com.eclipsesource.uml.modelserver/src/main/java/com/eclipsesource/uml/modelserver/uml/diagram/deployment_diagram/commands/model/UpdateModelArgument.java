...
public final class UpdateModelArgument {
   private String name;
   ...
   public static final class Builder {
      private final UpdateModelArgument argument = new UpdateModelArgument();
      ...
      public Builder visibilityKind(final VisibilityKind visibilityKind) {
         argument.visibilityKind = visibilityKind;
         return this;
      }

      public UpdateModelArgument get() {
         return argument;
      }
