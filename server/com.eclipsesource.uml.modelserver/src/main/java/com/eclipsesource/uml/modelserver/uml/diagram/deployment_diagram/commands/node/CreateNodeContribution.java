...
public final class CreateNodeContribution extends BasicCommandContribution<Command> {

   public static final String TYPE = "deployment:add_node";
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      try {
         ...
         return parent
            .<Command> map(p -> new CreateNodeCompoundCommand(context, p, position))
