...
public class CreateNodeDeviceSemanticCommand
   extends BaseCreateSemanticChildCommand<Device, Node> {

   public CreateNodeDeviceSemanticCommand(final ModelContext context, final Device parent) {
      super(context, parent);
   }

   @Override
   protected Node createSemanticElement(final Device parent) {
