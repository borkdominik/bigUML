...
public final class DeleteNodeCompoundCommand extends CompoundCommand {

   public DeleteNodeCompoundCommand(final ModelContext context, final Node semanticElement) {
      this.append(new DeleteNodeSemanticCommand(context, semanticElement));
