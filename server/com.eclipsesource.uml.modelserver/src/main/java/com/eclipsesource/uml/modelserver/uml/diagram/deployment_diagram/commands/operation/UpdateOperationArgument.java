...
public final class UpdateOperationArgument {
   private String name;
   ...
   private List<NewListIndex> parameterOrders;
   ...
   public Optional<List<NewListIndex>> parameterPosition() {
   ...
   public static final class Builder {
      ...
      public Builder parameterOrders(final List<NewListIndex> value) {
