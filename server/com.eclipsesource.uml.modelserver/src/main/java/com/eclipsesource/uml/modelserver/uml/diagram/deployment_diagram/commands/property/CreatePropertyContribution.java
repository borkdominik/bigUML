...
public final class CreatePropertyContribution extends BasicCommandContribution<Command> {

   public static final String TYPE = "deployment:add_property";
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      return parent
         .<Command> map(p -> new CreatePropertySemanticCommand(context, p))
