...
public final class CreatePackageContribution extends BasicCommandContribution<Command> {

   public static final String TYPE = "deployment:add_package";
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      try {
         ...
         return parent
            .<Command> map(p -> new CreatePackageCompoundCommand(context, p, position))
