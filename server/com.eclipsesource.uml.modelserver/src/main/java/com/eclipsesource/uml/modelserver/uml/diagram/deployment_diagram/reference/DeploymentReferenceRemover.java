...
public final class DeploymentReferenceRemover extends BaseCrossReferenceProcessor<Deployment> {

   @Override
   protected List<Command> process(final ModelContext context, final Setting setting, final Deployment self,
