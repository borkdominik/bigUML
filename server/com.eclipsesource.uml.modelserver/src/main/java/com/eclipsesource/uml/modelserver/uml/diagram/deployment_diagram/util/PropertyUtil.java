 ...
 ********************************************************************************/
package com.eclipsesource.uml.modelserver.uml.diagram.deployment_diagram.util;
...
public final class PropertyUtil {
   ...
   public static Type getType(final EditingDomain domain, final String typeName) {
      ...
      while (resourceSetContent.hasNext()) {
         ...
         if (res instanceof DataType || res instanceof org.eclipse.uml2.uml.DeploymentSpecification
            || res instanceof org.eclipse.uml2.uml.Artifact || res instanceof org.eclipse.uml2.uml.Deployment) {
