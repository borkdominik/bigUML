...
public class DeleteElementImportCompoundCommand extends CompoundCommand {

   public DeleteElementImportCompoundCommand(final ModelContext context, final ElementImport semanticElement) {
      this.append(new DeleteElementImportSemanticCommand(context, semanticElement));
