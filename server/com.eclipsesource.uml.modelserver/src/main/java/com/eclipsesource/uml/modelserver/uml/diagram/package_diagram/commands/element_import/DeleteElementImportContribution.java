...
public class DeleteElementImportContribution extends BasicCommandContribution<Command> {

   public static final String TYPE = "package:delete_element_import";
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      return element
         .<Command> map(e -> new DeleteElementImportCompoundCommand(context, e))
