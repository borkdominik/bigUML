...
public class CreatePackageContribution extends BasicCommandContribution<Command> {

   public static final String TYPE = "package:add_package";
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      return parent.<Command> map(p -> new CreatePackageCompoundCommand(context, p, position))
