...
public final class DeleteBehaviorExecutionContribution extends BasicCommandContribution<Command> {

   public static final String TYPE = "sequence:delete_behaviorExecution";
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      return element
         .<Command> map(e -> new DeleteBehaviorExecutionCompoundCommand(context, e))
