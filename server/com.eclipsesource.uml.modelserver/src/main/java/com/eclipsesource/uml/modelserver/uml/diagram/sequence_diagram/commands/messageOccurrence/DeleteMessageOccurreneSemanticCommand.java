...
public final class DeleteMessageOccurreneSemanticCommand
   extends BaseDeleteSemanticChildCommand<Interaction, MessageOccurrenceSpecification> {

   public DeleteMessageOccurreneSemanticCommand(final ModelContext context,
   ...
   @Override
   protected void deleteSemanticElement(final Interaction parent, final MessageOccurrenceSpecification child) {
