...
public final class UpdateMessageOccurrenceArgument {
   private String name;
   ...
   public static final class Builder {
      private final UpdateMessageOccurrenceArgument argument = new UpdateMessageOccurrenceArgument();
      ...
      public UpdateMessageOccurrenceArgument get() {
         return argument;
      }
   }
}
