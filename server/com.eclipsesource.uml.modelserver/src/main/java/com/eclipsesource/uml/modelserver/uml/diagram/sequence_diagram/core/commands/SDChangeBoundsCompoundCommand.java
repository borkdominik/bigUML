...
import com.eclipsesource.uml.modelserver.uml.diagram.sequence_diagram.core.commands.SDLifelineLayoutCommand;
import com.eclipsesource.uml.modelserver.uml.diagram.sequence_diagram.core.commands.SDWrapBoundsCommand;

public class SDChangeBoundsCompoundCommand extends CompoundCommand {
   ...
   public SDChangeBoundsCompoundCommand(final ModelContext context) {
      ...
      append(new SDLifelineLayoutCommand(context, bounds));
      append(new SDWrapBoundsCommand(context, bounds));
   ...
   private Command createCommand(final ElementAndBounds bound) {
      ...
      if (element.isEmpty()) {
         return new SDChangeBoundsNotationCommand(
            context,
      ...
      if (element.get() instanceof Lifeline
         ...
         return element
            .<Command> map(e -> new SDChangeBoundsNotationCommand(
               context,
               e,
