...
import com.eclipsesource.uml.modelserver.core.commands.change_bounds.UmlWrapBoundsCommand;
import com.eclipsesource.uml.modelserver.shared.extension.SemanticElementAccessor;
import com.eclipsesource.uml.modelserver.shared.model.ModelContext;

public class SDLifelineLayoutCommand extends UmlWrapBoundsCommand {
   protected final List<ElementAndBounds> bounds;
   protected final boolean autoLayout = false; // currently hardcoded but could be made configurable by user
   protected final double defaultY = 30;

   public SDLifelineLayoutCommand(final ModelContext context,
