...
public class SDAddShapeNotationCommand extends BaseNotationElementCommand {
   ...
   public SDAddShapeNotationCommand(final ModelContext context, final Supplier<? extends EObject> semanticElementSupplier,
