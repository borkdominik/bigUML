...
public class DeleteStateCompoundCommand extends CompoundCommand {

   public DeleteStateCompoundCommand(final ModelContext context, final State semanticElement) {
      this.append(new DeleteStateSemanticCommand(context, semanticElement));
