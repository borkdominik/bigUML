...
public class CreateStateMachineContribution extends BasicCommandContribution<Command> {

   public static final String TYPE = "state_machine:add_state_machine";
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      return parent
         .<Command> map(p -> new CreateStateMachineCompoundCommand(context, p, position))
