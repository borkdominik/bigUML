...
public class CreateActorContribution extends BasicCommandContribution<Command> {

   public static final String TYPE = "use_case:add_actor";
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      return parent
         .<Command> map(p -> new CreateActorCompoundCommand(context, p, position))
