...
public class DeleteActorCompoundCommand extends CompoundCommand {

   public DeleteActorCompoundCommand(final ModelContext context, final Actor semanticElement) {
      this.append(new DeleteActorSemanticCommand(context, semanticElement));
