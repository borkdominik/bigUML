...
public class CreateIncludeCompoundCommand extends CompoundCommand {

   public CreateIncludeCompoundCommand(final ModelContext context,
      final UseCase source,
      final UseCase target) {

      var command = new CreateIncludeSemanticCommand(context, source, target);
      this.append(command);
