...
public class CreateIncludeContribution extends BasicCommandContribution<Command> {

   public static final String TYPE = "use_case:add_include";
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      if (source.isPresent() && target.isPresent()) {
         return new CreateIncludeCompoundCommand(context, source.get(), target.get());
      }
