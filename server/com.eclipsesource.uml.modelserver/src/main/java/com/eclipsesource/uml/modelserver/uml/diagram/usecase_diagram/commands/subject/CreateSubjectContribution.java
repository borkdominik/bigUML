...
public class CreateSubjectContribution extends BasicCommandContribution<Command> {
   public static final String TYPE = "use_case:add_subject";
   ...
   protected Command toServer(final URI modelUri, final EditingDomain domain, final CCommand command)
      ...
      return parent
         .<Command> map(p -> new CreateSubjectCompoundCommand(context, p, position))
