...
public class DeleteSubjectCompoundCommand extends CompoundCommand {

   public DeleteSubjectCompoundCommand(final ModelContext context, final Component semanticElement) {
      this.append(new DeleteSubjectSemanticCommand(context, semanticElement));
