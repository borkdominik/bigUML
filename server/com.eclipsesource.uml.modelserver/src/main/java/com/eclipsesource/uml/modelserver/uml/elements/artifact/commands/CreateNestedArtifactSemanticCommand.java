...
public class CreateNestedArtifactSemanticCommand extends BaseCreateSemanticChildCommand<Artifact, Artifact> {

   public CreateNestedArtifactSemanticCommand(final ModelContext context, final Artifact parent) {
