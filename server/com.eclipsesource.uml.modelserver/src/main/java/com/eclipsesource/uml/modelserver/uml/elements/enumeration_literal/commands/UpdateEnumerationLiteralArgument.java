...
public class UpdateEnumerationLiteralArgument extends UpdateNamedElementArgument {

   public static Builder<?> by() {
      return new Builder<>();
   }

   public static class Builder<TArgument extends UpdateEnumerationLiteralArgument>
