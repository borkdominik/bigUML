 ...
 ********************************************************************************/
package com.eclipsesource.uml.modelserver.uml.elements.node;
...
import com.eclipsesource.uml.modelserver.uml.elements.node.commands.AddNestedNodeSemanticCommand;
...
public class NodeCommandProvider
   extends com.eclipsesource.uml.modelserver.uml.command.provider.element.NodeCommandProvider<Node, Element> {
   ...
   protected Collection<Command> createModifications(final ModelContext context, final Element parent,
      ...
      if (parent instanceof Package) {
         ...
         semantic = new AddNestedNodeSemanticCommand(context, (Node) parent, p -> {
            return UMLFactory.eINSTANCE.createNode();
         });
      } else {
   ...
   @Override
   protected Collection<Command> updateModifications(final ModelContext context, final Node element) {
      var decoder = new ContributionDecoder(context);
      var update = decoder.embedJson(UpdateNodeArgument.class);
      return List.of(new UpdateNodeSemanticCommand(context, element, update));
   }
