...
public class UpdateNodeArgument extends UpdateClassArgument {

   public static Builder<?> by() {
      return new Builder<>();
   }

   public static class Builder<TArgument extends UpdateNodeArgument>
      extends UpdateClassArgument.Builder<TArgument> {
