...
public class UpdatePrimitiveTypeArgument extends UpdateDataTypeArgument {

   public static Builder<?> by() {
      return new Builder<>();
   }

   public static class Builder<TArgument extends UpdatePrimitiveTypeArgument>
      extends UpdateDataTypeArgument.Builder<TArgument> {
